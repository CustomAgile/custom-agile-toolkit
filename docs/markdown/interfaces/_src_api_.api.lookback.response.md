[custom-agile-toolkit](../README.md) > ["src/Api"](../modules/_src_api_.md) > [Api](../modules/_src_api_.api.md) > [Lookback](../modules/_src_api_.api.lookback.md) > [Response](../interfaces/_src_api_.api.lookback.response.md)
...
* [$getAll](_src_api_.api.lookback.response.md#_getall)
* [$getNextPage](_src_api_.api.lookback.response.md#_getnextpage)
* [$hasMore](_src_api_.api.lookback.response.md#_hasmore)
* [$params](_src_api_.api.lookback.response.md#_params)
* [$rawResponse](_src_api_.api.lookback.response.md#_rawresponse)
* [Array](_src_api_.api.lookback.response.md#array)
* [length](_src_api_.api.lookback.response.md#length)

### Methods

* [__@iterator](_src_api_.api.lookback.response.md#___iterator)
* [__@unscopables](_src_api_.api.lookback.response.md#___unscopables)
* [concat](_src_api_.api.lookback.response.md#concat)
* [copyWithin](_src_api_.api.lookback.response.md#copywithin)
* [entries](_src_api_.api.lookback.response.md#entries)
* [every](_src_api_.api.lookback.response.md#every)
* [fill](_src_api_.api.lookback.response.md#fill)
* [filter](_src_api_.api.lookback.response.md#filter)
* [find](_src_api_.api.lookback.response.md#find)
* [findIndex](_src_api_.api.lookback.response.md#findindex)
* [flat](_src_api_.api.lookback.response.md#flat)
* [flatMap](_src_api_.api.lookback.response.md#flatmap)
* [forEach](_src_api_.api.lookback.response.md#foreach)
* [includes](_src_api_.api.lookback.response.md#includes)
* [indexOf](_src_api_.api.lookback.response.md#indexof)
* [join](_src_api_.api.lookback.response.md#join)
* [keys](_src_api_.api.lookback.response.md#keys)
* [lastIndexOf](_src_api_.api.lookback.response.md#lastindexof)
* [map](_src_api_.api.lookback.response.md#map)
* [pop](_src_api_.api.lookback.response.md#pop)
* [push](_src_api_.api.lookback.response.md#push)
* [reduce](_src_api_.api.lookback.response.md#reduce)
* [reduceRight](_src_api_.api.lookback.response.md#reduceright)
* [reverse](_src_api_.api.lookback.response.md#reverse)
* [shift](_src_api_.api.lookback.response.md#shift)
* [slice](_src_api_.api.lookback.response.md#slice)
* [some](_src_api_.api.lookback.response.md#some)
* [sort](_src_api_.api.lookback.response.md#sort)
* [splice](_src_api_.api.lookback.response.md#splice)
* [toLocaleString](_src_api_.api.lookback.response.md#tolocalestring)
* [toString](_src_api_.api.lookback.response.md#tostring)
* [unshift](_src_api_.api.lookback.response.md#unshift)
* [values](_src_api_.api.lookback.response.md#values)
...
*Defined in [src/Api.ts:70](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/Api.ts#L70)*

returns all the data from the later pages including this page

#### Type declaration
▸(): `Promise`<[Response](_src_api_.api.lookback.response.md)>

**Returns:** `Promise`<[Response](_src_api_.api.lookback.response.md)>
...
*Defined in [src/Api.ts:72](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/Api.ts#L72)*
...
*Defined in [src/Api.ts:67](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/Api.ts#L67)*
...
*Defined in [src/Api.ts:66](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/Api.ts#L66)*
...
**● $rawResponse**: *[RawResponse](_src_api_.api.lookback.rawresponse.md)*

*Defined in [src/Api.ts:68](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/Api.ts#L68)*
