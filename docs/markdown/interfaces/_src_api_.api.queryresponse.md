[custom-agile-toolkit](../README.md) > ["src/Api"](../modules/_src_api_.md) > [Api](../modules/_src_api_.api.md) > [QueryResponse](../interfaces/_src_api_.api.queryresponse.md)

# Interface: QueryResponse

## Type parameters
#### T :  [RallyObject](_src_api_.api.rallyobject.md)
## Hierarchy
...
* [$getAll](_src_api_.api.queryresponse.md#_getall)
* [$getNextPage](_src_api_.api.queryresponse.md#_getnextpage)
* [$hasMore](_src_api_.api.queryresponse.md#_hasmore)
* [$params](_src_api_.api.queryresponse.md#_params)
* [Array](_src_api_.api.queryresponse.md#array)
* [length](_src_api_.api.queryresponse.md#length)

### Methods

* [__@iterator](_src_api_.api.queryresponse.md#___iterator)
* [__@unscopables](_src_api_.api.queryresponse.md#___unscopables)
* [concat](_src_api_.api.queryresponse.md#concat)
* [copyWithin](_src_api_.api.queryresponse.md#copywithin)
* [entries](_src_api_.api.queryresponse.md#entries)
* [every](_src_api_.api.queryresponse.md#every)
* [fill](_src_api_.api.queryresponse.md#fill)
* [filter](_src_api_.api.queryresponse.md#filter)
* [find](_src_api_.api.queryresponse.md#find)
* [findIndex](_src_api_.api.queryresponse.md#findindex)
* [flat](_src_api_.api.queryresponse.md#flat)
* [flatMap](_src_api_.api.queryresponse.md#flatmap)
* [forEach](_src_api_.api.queryresponse.md#foreach)
* [includes](_src_api_.api.queryresponse.md#includes)
* [indexOf](_src_api_.api.queryresponse.md#indexof)
* [join](_src_api_.api.queryresponse.md#join)
* [keys](_src_api_.api.queryresponse.md#keys)
* [lastIndexOf](_src_api_.api.queryresponse.md#lastindexof)
* [map](_src_api_.api.queryresponse.md#map)
* [pop](_src_api_.api.queryresponse.md#pop)
* [push](_src_api_.api.queryresponse.md#push)
* [reduce](_src_api_.api.queryresponse.md#reduce)
* [reduceRight](_src_api_.api.queryresponse.md#reduceright)
* [reverse](_src_api_.api.queryresponse.md#reverse)
* [shift](_src_api_.api.queryresponse.md#shift)
* [slice](_src_api_.api.queryresponse.md#slice)
* [some](_src_api_.api.queryresponse.md#some)
* [sort](_src_api_.api.queryresponse.md#sort)
* [splice](_src_api_.api.queryresponse.md#splice)
* [toLocaleString](_src_api_.api.queryresponse.md#tolocalestring)
* [toString](_src_api_.api.queryresponse.md#tostring)
* [unshift](_src_api_.api.queryresponse.md#unshift)
* [values](_src_api_.api.queryresponse.md#values)
...
*Defined in [src/Api.ts:49](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/Api.ts#L49)*

returns all the data from the later pages including this page

#### Type declaration
▸(): `Promise`<[QueryResponse](_src_api_.api.queryresponse.md)<`T`>>

**Returns:** `Promise`<[QueryResponse](_src_api_.api.queryresponse.md)<`T`>>
...
*Defined in [src/Api.ts:51](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/Api.ts#L51)*
...
*Defined in [src/Api.ts:47](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/Api.ts#L47)*
...
*Defined in [src/Api.ts:46](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/Api.ts#L46)*
