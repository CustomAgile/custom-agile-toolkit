[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [BuildDefinition](../classes/_src_classclients_.classclients.builddefinition.md)

# Class: BuildDefinition

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`BuildDefinition`>
...
* [constructor](_src_classclients_.classclients.builddefinition.md#constructor)

### Properties

* [client](_src_classclients_.classclients.builddefinition.md#client)
* [typeName](_src_classclients_.classclients.builddefinition.md#typename)

### Methods

* [delete](_src_classclients_.classclients.builddefinition.md#delete)
* [get](_src_classclients_.classclients.builddefinition.md#get)
* [getCollection](_src_classclients_.classclients.builddefinition.md#getcollection)
* [query](_src_classclients_.classclients.builddefinition.md#query)
* [save](_src_classclients_.classclients.builddefinition.md#save)
...
⊕ **new BuildDefinition**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [BuildDefinition](_src_classclients_.classclients.builddefinition.md)

⊕ **new BuildDefinition**(client: *[Client](_src_client_.client.md)*): [BuildDefinition](_src_classclients_.classclients.builddefinition.md)
...
*Defined in [src/ClassClients.ts:170](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L170)*
...
**Returns:** [BuildDefinition](_src_classclients_.classclients.builddefinition.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:171](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L171)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`BuildDefinition`>
...
▸ **getCollection**(rallyObject: *`BuildDefinition`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`BuildDefinition`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`BuildDefinition`>>
...
▸ **save**(rallyObject: *`Partial`<`BuildDefinition`>*): `Promise`<`BuildDefinition`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`BuildDefinition`> |  A new or existing Rally object |
