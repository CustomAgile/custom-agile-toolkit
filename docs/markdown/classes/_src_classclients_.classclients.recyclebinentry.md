[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [RecycleBinEntry](../classes/_src_classclients_.classclients.recyclebinentry.md)

# Class: RecycleBinEntry

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`RecycleBinEntry`>
...
* [constructor](_src_classclients_.classclients.recyclebinentry.md#constructor)

### Properties

* [client](_src_classclients_.classclients.recyclebinentry.md#client)
* [typeName](_src_classclients_.classclients.recyclebinentry.md#typename)

### Methods

* [delete](_src_classclients_.classclients.recyclebinentry.md#delete)
* [get](_src_classclients_.classclients.recyclebinentry.md#get)
* [getCollection](_src_classclients_.classclients.recyclebinentry.md#getcollection)
* [query](_src_classclients_.classclients.recyclebinentry.md#query)
* [save](_src_classclients_.classclients.recyclebinentry.md#save)
...
⊕ **new RecycleBinEntry**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [RecycleBinEntry](_src_classclients_.classclients.recyclebinentry.md)

⊕ **new RecycleBinEntry**(client: *[Client](_src_client_.client.md)*): [RecycleBinEntry](_src_classclients_.classclients.recyclebinentry.md)
...
*Defined in [src/ClassClients.ts:476](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L476)*
...
**Returns:** [RecycleBinEntry](_src_classclients_.classclients.recyclebinentry.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:477](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L477)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`RecycleBinEntry`>
...
**Returns:** `Promise`<`RecycleBinEntry`>
...
▸ **getCollection**(rallyObject: *`RecycleBinEntry`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`RecycleBinEntry`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`RecycleBinEntry`>>
...
▸ **save**(rallyObject: *`Partial`<`RecycleBinEntry`>*): `Promise`<`RecycleBinEntry`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`RecycleBinEntry`> |  A new or existing Rally object |
