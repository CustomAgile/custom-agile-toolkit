[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [User](../classes/_src_classclients_.classclients.user.md)

# Class: User

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`User`>
...
* [constructor](_src_classclients_.classclients.user.md#constructor)

### Properties

* [client](_src_classclients_.classclients.user.md#client)
* [typeName](_src_classclients_.classclients.user.md#typename)

### Methods

* [delete](_src_classclients_.classclients.user.md#delete)
* [get](_src_classclients_.classclients.user.md#get)
* [getCollection](_src_classclients_.classclients.user.md#getcollection)
* [query](_src_classclients_.classclients.user.md#query)
* [save](_src_classclients_.classclients.user.md#save)
...
⊕ **new User**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [User](_src_classclients_.classclients.user.md)

⊕ **new User**(client: *[Client](_src_client_.client.md)*): [User](_src_classclients_.classclients.user.md)
...
*Defined in [src/ClassClients.ts:719](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L719)*
...
**Returns:** [User](_src_classclients_.classclients.user.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:720](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L720)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`User`>
...
▸ **getCollection**(rallyObject: *`User`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`User`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`User`>>
...
▸ **save**(rallyObject: *`Partial`<`User`>*): `Promise`<`User`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`User`> |  A new or existing Rally object |
