[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [TypeDefinition](../classes/_src_classclients_.classclients.typedefinition.md)

# Class: TypeDefinition

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`TypeDefinition`>
...
* [constructor](_src_classclients_.classclients.typedefinition.md#constructor)

### Properties

* [client](_src_classclients_.classclients.typedefinition.md#client)
* [typeName](_src_classclients_.classclients.typedefinition.md#typename)

### Methods

* [delete](_src_classclients_.classclients.typedefinition.md#delete)
* [get](_src_classclients_.classclients.typedefinition.md#get)
* [getCollection](_src_classclients_.classclients.typedefinition.md#getcollection)
* [query](_src_classclients_.classclients.typedefinition.md#query)
* [save](_src_classclients_.classclients.typedefinition.md#save)
...
⊕ **new TypeDefinition**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [TypeDefinition](_src_classclients_.classclients.typedefinition.md)

⊕ **new TypeDefinition**(client: *[Client](_src_client_.client.md)*): [TypeDefinition](_src_classclients_.classclients.typedefinition.md)
...
*Defined in [src/ClassClients.ts:710](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L710)*
...
**Returns:** [TypeDefinition](_src_classclients_.classclients.typedefinition.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:711](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L711)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`TypeDefinition`>
...
▸ **getCollection**(rallyObject: *`TypeDefinition`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TypeDefinition`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TypeDefinition`>>
...
▸ **save**(rallyObject: *`Partial`<`TypeDefinition`>*): `Promise`<`TypeDefinition`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`TypeDefinition`> |  A new or existing Rally object |
