[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Defect](../classes/_classclients_.classclients.defect.md)

# Class: Defect

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Defect`>
...
* [constructor](_classclients_.classclients.defect.md#constructor)

### Properties

* [client](_classclients_.classclients.defect.md#client)
* [typeName](_classclients_.classclients.defect.md#typename)

### Methods

* [delete](_classclients_.classclients.defect.md#delete)
* [get](_classclients_.classclients.defect.md#get)
* [getCollection](_classclients_.classclients.defect.md#getcollection)
* [query](_classclients_.classclients.defect.md#query)
* [save](_classclients_.classclients.defect.md#save)
...
⊕ **new Defect**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Defect](_classclients_.classclients.defect.md)

⊕ **new Defect**(client: *[Client](_client_.client.md)*): [Defect](_classclients_.classclients.defect.md)
...
*Defined in [ClassClients.ts:242](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L242)*
...
**Returns:** [Defect](_classclients_.classclients.defect.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:243](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L243)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Defect`>
...
▸ **getCollection**(rallyObject: *`Defect`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Defect`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Defect`>>
