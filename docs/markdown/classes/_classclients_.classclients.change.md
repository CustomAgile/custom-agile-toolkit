[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Change](../classes/_classclients_.classclients.change.md)

# Class: Change

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Change`>
...
* [constructor](_classclients_.classclients.change.md#constructor)

### Properties

* [client](_classclients_.classclients.change.md#client)
* [typeName](_classclients_.classclients.change.md#typename)

### Methods

* [delete](_classclients_.classclients.change.md#delete)
* [get](_classclients_.classclients.change.md#get)
* [getCollection](_classclients_.classclients.change.md#getcollection)
* [query](_classclients_.classclients.change.md#query)
* [save](_classclients_.classclients.change.md#save)
...
⊕ **new Change**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Change](_classclients_.classclients.change.md)

⊕ **new Change**(client: *[Client](_client_.client.md)*): [Change](_classclients_.classclients.change.md)
...
*Defined in [ClassClients.ts:179](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L179)*
...
**Returns:** [Change](_classclients_.classclients.change.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:180](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L180)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Change`>
...
▸ **getCollection**(rallyObject: *`Change`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Change`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Change`>>
