[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Connection](../classes/_classclients_.classclients.connection.md)

# Class: Connection

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Connection`>
...
* [constructor](_classclients_.classclients.connection.md#constructor)

### Properties

* [client](_classclients_.classclients.connection.md#client)
* [typeName](_classclients_.classclients.connection.md#typename)

### Methods

* [delete](_classclients_.classclients.connection.md#delete)
* [get](_classclients_.classclients.connection.md#get)
* [getCollection](_classclients_.classclients.connection.md#getcollection)
* [query](_classclients_.classclients.connection.md#query)
* [save](_classclients_.classclients.connection.md#save)
...
⊕ **new Connection**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Connection](_classclients_.classclients.connection.md)

⊕ **new Connection**(client: *[Client](_client_.client.md)*): [Connection](_classclients_.classclients.connection.md)
...
*Defined in [ClassClients.ts:197](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L197)*
...
**Returns:** [Connection](_classclients_.classclients.connection.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:198](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L198)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Connection`>
...
▸ **getCollection**(rallyObject: *`Connection`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Connection`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Connection`>>
