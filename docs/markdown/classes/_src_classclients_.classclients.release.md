[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Release](../classes/_src_classclients_.classclients.release.md)

# Class: Release

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Release`>
...
* [constructor](_src_classclients_.classclients.release.md#constructor)

### Properties

* [client](_src_classclients_.classclients.release.md#client)
* [typeName](_src_classclients_.classclients.release.md#typename)

### Methods

* [delete](_src_classclients_.classclients.release.md#delete)
* [get](_src_classclients_.classclients.release.md#get)
* [getCollection](_src_classclients_.classclients.release.md#getcollection)
* [query](_src_classclients_.classclients.release.md#query)
* [save](_src_classclients_.classclients.release.md#save)
...
⊕ **new Release**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Release](_src_classclients_.classclients.release.md)

⊕ **new Release**(client: *[Client](_src_client_.client.md)*): [Release](_src_classclients_.classclients.release.md)
...
*Defined in [src/ClassClients.ts:485](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L485)*
...
**Returns:** [Release](_src_classclients_.classclients.release.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:486](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L486)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Release`>
...
▸ **getCollection**(rallyObject: *`Release`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Release`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Release`>>
...
▸ **save**(rallyObject: *`Partial`<`Release`>*): `Promise`<`Release`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Release`> |  A new or existing Rally object |
