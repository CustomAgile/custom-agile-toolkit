[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [TypeDefinition](../classes/_classclients_.classclients.typedefinition.md)

# Class: TypeDefinition

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`TypeDefinition`>
...
* [constructor](_classclients_.classclients.typedefinition.md#constructor)

### Properties

* [client](_classclients_.classclients.typedefinition.md#client)
* [typeName](_classclients_.classclients.typedefinition.md#typename)

### Methods

* [delete](_classclients_.classclients.typedefinition.md#delete)
* [get](_classclients_.classclients.typedefinition.md#get)
* [getCollection](_classclients_.classclients.typedefinition.md#getcollection)
* [query](_classclients_.classclients.typedefinition.md#query)
* [save](_classclients_.classclients.typedefinition.md#save)
...
⊕ **new TypeDefinition**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [TypeDefinition](_classclients_.classclients.typedefinition.md)

⊕ **new TypeDefinition**(client: *[Client](_client_.client.md)*): [TypeDefinition](_classclients_.classclients.typedefinition.md)
...
*Defined in [ClassClients.ts:710](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L710)*
...
**Returns:** [TypeDefinition](_classclients_.classclients.typedefinition.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:711](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L711)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`TypeDefinition`>
...
▸ **getCollection**(rallyObject: *`TypeDefinition`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TypeDefinition`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TypeDefinition`>>
