[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [PullRequest](../classes/_src_classclients_.classclients.pullrequest.md)

# Class: PullRequest

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`PullRequest`>
...
* [constructor](_src_classclients_.classclients.pullrequest.md#constructor)

### Properties

* [client](_src_classclients_.classclients.pullrequest.md#client)
* [typeName](_src_classclients_.classclients.pullrequest.md#typename)

### Methods

* [delete](_src_classclients_.classclients.pullrequest.md#delete)
* [get](_src_classclients_.classclients.pullrequest.md#get)
* [getCollection](_src_classclients_.classclients.pullrequest.md#getcollection)
* [query](_src_classclients_.classclients.pullrequest.md#query)
* [save](_src_classclients_.classclients.pullrequest.md#save)
...
⊕ **new PullRequest**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [PullRequest](_src_classclients_.classclients.pullrequest.md)

⊕ **new PullRequest**(client: *[Client](_src_client_.client.md)*): [PullRequest](_src_classclients_.classclients.pullrequest.md)
...
*Defined in [src/ClassClients.ts:458](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L458)*
...
**Returns:** [PullRequest](_src_classclients_.classclients.pullrequest.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:459](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L459)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`PullRequest`>
...
▸ **getCollection**(rallyObject: *`PullRequest`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PullRequest`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PullRequest`>>
...
▸ **save**(rallyObject: *`Partial`<`PullRequest`>*): `Promise`<`PullRequest`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`PullRequest`> |  A new or existing Rally object |
