[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [ScopedAttributeDefinition](../classes/_classclients_.classclients.scopedattributedefinition.md)

# Class: ScopedAttributeDefinition

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`ScopedAttributeDefinition`>
...
* [constructor](_classclients_.classclients.scopedattributedefinition.md#constructor)

### Properties

* [client](_classclients_.classclients.scopedattributedefinition.md#client)
* [typeName](_classclients_.classclients.scopedattributedefinition.md#typename)

### Methods

* [delete](_classclients_.classclients.scopedattributedefinition.md#delete)
* [get](_classclients_.classclients.scopedattributedefinition.md#get)
* [getCollection](_classclients_.classclients.scopedattributedefinition.md#getcollection)
* [query](_classclients_.classclients.scopedattributedefinition.md#query)
* [save](_classclients_.classclients.scopedattributedefinition.md#save)
...
⊕ **new ScopedAttributeDefinition**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [ScopedAttributeDefinition](_classclients_.classclients.scopedattributedefinition.md)

⊕ **new ScopedAttributeDefinition**(client: *[Client](_client_.client.md)*): [ScopedAttributeDefinition](_classclients_.classclients.scopedattributedefinition.md)
...
*Defined in [ClassClients.ts:575](https://github.com/ferentchak/rally-node-sdk/blob/45aae0f/ClassClients.ts#L575)*
...
**Returns:** [ScopedAttributeDefinition](_classclients_.classclients.scopedattributedefinition.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:576](https://github.com/ferentchak/rally-node-sdk/blob/45aae0f/ClassClients.ts#L576)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`ScopedAttributeDefinition`>
...
▸ **getCollection**(rallyObject: *`ScopedAttributeDefinition`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`ScopedAttributeDefinition`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`ScopedAttributeDefinition`>>
