[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [AttachmentContent](../classes/_src_classclients_.classclients.attachmentcontent.md)

# Class: AttachmentContent

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`AttachmentContent`>
...
* [constructor](_src_classclients_.classclients.attachmentcontent.md#constructor)

### Properties

* [client](_src_classclients_.classclients.attachmentcontent.md#client)
* [typeName](_src_classclients_.classclients.attachmentcontent.md#typename)

### Methods

* [delete](_src_classclients_.classclients.attachmentcontent.md#delete)
* [get](_src_classclients_.classclients.attachmentcontent.md#get)
* [getCollection](_src_classclients_.classclients.attachmentcontent.md#getcollection)
* [query](_src_classclients_.classclients.attachmentcontent.md#query)
* [save](_src_classclients_.classclients.attachmentcontent.md#save)
...
⊕ **new AttachmentContent**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [AttachmentContent](_src_classclients_.classclients.attachmentcontent.md)

⊕ **new AttachmentContent**(client: *[Client](_src_client_.client.md)*): [AttachmentContent](_src_classclients_.classclients.attachmentcontent.md)
...
*Defined in [src/ClassClients.ts:134](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L134)*
...
**Returns:** [AttachmentContent](_src_classclients_.classclients.attachmentcontent.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:135](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L135)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`AttachmentContent`>
...
**Returns:** `Promise`<`AttachmentContent`>
...
▸ **getCollection**(rallyObject: *`AttachmentContent`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`AttachmentContent`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`AttachmentContent`>>
...
▸ **save**(rallyObject: *`Partial`<`AttachmentContent`>*): `Promise`<`AttachmentContent`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`AttachmentContent`> |  A new or existing Rally object |
