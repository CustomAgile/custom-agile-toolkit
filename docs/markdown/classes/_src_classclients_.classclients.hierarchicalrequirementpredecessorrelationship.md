[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [HierarchicalRequirementPredecessorRelationship](../classes/_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md)

# Class: HierarchicalRequirementPredecessorRelationship

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`HierarchicalRequirementPredecessorRelationship`>
...
* [constructor](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md#constructor)

### Properties

* [client](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md#client)
* [typeName](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md#typename)

### Methods

* [delete](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md#delete)
* [get](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md#get)
* [getCollection](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md#getcollection)
* [query](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md#query)
* [save](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md#save)
...
⊕ **new HierarchicalRequirementPredecessorRelationship**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [HierarchicalRequirementPredecessorRelationship](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md)

⊕ **new HierarchicalRequirementPredecessorRelationship**(client: *[Client](_src_client_.client.md)*): [HierarchicalRequirementPredecessorRelationship](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md)
...
*Defined in [src/ClassClients.ts:305](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L305)*
...
**Returns:** [HierarchicalRequirementPredecessorRelationship](_src_classclients_.classclients.hierarchicalrequirementpredecessorrelationship.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:306](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L306)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`HierarchicalRequirementPredecessorRelationship`>
...
▸ **getCollection**(rallyObject: *`HierarchicalRequirementPredecessorRelationship`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`HierarchicalRequirementPredecessorRelationship`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`HierarchicalRequirementPredecessorRelationship`>>
