[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Panel](../classes/_classclients_.classclients.panel.md)

# Class: Panel

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Panel`>
...
* [constructor](_classclients_.classclients.panel.md#constructor)

### Properties

* [client](_classclients_.classclients.panel.md#client)
* [typeName](_classclients_.classclients.panel.md#typename)

### Methods

* [delete](_classclients_.classclients.panel.md#delete)
* [get](_classclients_.classclients.panel.md#get)
* [getCollection](_classclients_.classclients.panel.md#getcollection)
* [query](_classclients_.classclients.panel.md#query)
* [save](_classclients_.classclients.panel.md#save)
...
⊕ **new Panel**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Panel](_classclients_.classclients.panel.md)

⊕ **new Panel**(client: *[Client](_client_.client.md)*): [Panel](_classclients_.classclients.panel.md)
...
*Defined in [ClassClients.ts:368](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L368)*
...
**Returns:** [Panel](_classclients_.classclients.panel.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:369](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L369)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Panel`>
...
▸ **getCollection**(rallyObject: *`Panel`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Panel`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Panel`>>
