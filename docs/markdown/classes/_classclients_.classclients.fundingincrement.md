[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [FundingIncrement](../classes/_classclients_.classclients.fundingincrement.md)



# Class: FundingIncrement

## Hierarchy


 [ClassClientBase](_classclients_.classclients.classclientbase.md)`FundingIncrement`
...
* [constructor](_classclients_.classclients.fundingincrement.md#constructor)


### Properties

* [client](_classclients_.classclients.fundingincrement.md#client)
* [typeName](_classclients_.classclients.fundingincrement.md#typename)


### Methods

* [delete](_classclients_.classclients.fundingincrement.md#delete)
* [get](_classclients_.classclients.fundingincrement.md#get)
* [getCollection](_classclients_.classclients.fundingincrement.md#getcollection)
* [query](_classclients_.classclients.fundingincrement.md#query)
* [save](_classclients_.classclients.fundingincrement.md#save)
...
### ⊕ **new FundingIncrement**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [FundingIncrement](_classclients_.classclients.fundingincrement.md)


### ⊕ **new FundingIncrement**(client: *[Client](_client_.client.md)*): [FundingIncrement](_classclients_.classclients.fundingincrement.md)
...
*Defined in ClassClients.ts:296*
...
**Returns:** [FundingIncrement](_classclients_.classclients.fundingincrement.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in ClassClients.ts:297*
...
► **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`.<`FundingIncrement`>
...
**Returns:** `Promise`.<`FundingIncrement`>
...
► **getCollection**(rallyObject: *`FundingIncrement`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`.<[QueryResponse](../interfaces/_api_.api.queryresponse.md)[RallyObject](../interfaces/_api_.api.rallyobject.md)>
...
► **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`.<[QueryResponse](../interfaces/_api_.api.queryresponse.md)`FundingIncrement`>
...
**Returns:** `Promise`.<[QueryResponse](../interfaces/_api_.api.queryresponse.md)`FundingIncrement`>
...
► **save**(rallyObject: *`Partial`.<`FundingIncrement`>*): `Promise`.<`FundingIncrement`>
...
| Param | Type | Description |
| ------ | ------ | ------ |
| rallyObject | `Partial`.<`FundingIncrement`>   |  A new or existing Rally object |
