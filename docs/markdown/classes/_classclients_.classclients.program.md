[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Program](../classes/_classclients_.classclients.program.md)
...
## Hierarchy
 ...
 [ClassClientBase](_classclients_.classclients.classclientbase.md)`Program`
...
* [constructor](_classclients_.classclients.program.md#constructor)


### Properties

* [client](_classclients_.classclients.program.md#client)
* [typeName](_classclients_.classclients.program.md#typename)


### Methods

* [delete](_classclients_.classclients.program.md#delete)
* [get](_classclients_.classclients.program.md#get)
* [getCollection](_classclients_.classclients.program.md#getcollection)
* [query](_classclients_.classclients.program.md#query)
* [save](_classclients_.classclients.program.md#save)
...
### ⊕ **new Program**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Program](_classclients_.classclients.program.md)


### ⊕ **new Program**(client: *[Client](_client_.client.md)*): [Program](_classclients_.classclients.program.md)
...
*Defined in ClassClients.ts:431*
...
**Returns:** [Program](_classclients_.classclients.program.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in ClassClients.ts:432*
...
► **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`.<`Program`>
...
► **getCollection**(rallyObject: *`Program`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`.<[QueryResponse](../interfaces/_api_.api.queryresponse.md)[RallyObject](../interfaces/_api_.api.rallyobject.md)>
...
► **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`.<[QueryResponse](../interfaces/_api_.api.queryresponse.md)`Program`>
...
**Returns:** `Promise`.<[QueryResponse](../interfaces/_api_.api.queryresponse.md)`Program`>
...
► **save**(rallyObject: *`Partial`.<`Program`>*): `Promise`.<`Program`>
...
| Param | Type | Description |
| ------ | ------ | ------ |
| rallyObject | `Partial`.<`Program`>   |  A new or existing Rally object |
