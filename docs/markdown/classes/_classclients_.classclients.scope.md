[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Scope](../classes/_classclients_.classclients.scope.md)

# Class: Scope

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Scope`>
...
* [constructor](_classclients_.classclients.scope.md#constructor)

### Properties

* [client](_classclients_.classclients.scope.md#client)
* [typeName](_classclients_.classclients.scope.md#typename)

### Methods

* [delete](_classclients_.classclients.scope.md#delete)
* [get](_classclients_.classclients.scope.md#get)
* [getCollection](_classclients_.classclients.scope.md#getcollection)
* [query](_classclients_.classclients.scope.md#query)
* [save](_classclients_.classclients.scope.md#save)
...
⊕ **new Scope**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Scope](_classclients_.classclients.scope.md)

⊕ **new Scope**(client: *[Client](_client_.client.md)*): [Scope](_classclients_.classclients.scope.md)
...
*Defined in [ClassClients.ts:566](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L566)*
...
**Returns:** [Scope](_classclients_.classclients.scope.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:567](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L567)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Scope`>
...
▸ **getCollection**(rallyObject: *`Scope`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Scope`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Scope`>>
...
▸ **save**(rallyObject: *`Partial`<`Scope`>*): `Promise`<`Scope`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Scope`> |  A new or existing Rally object |
