[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Defect](../classes/_src_classclients_.classclients.defect.md)

# Class: Defect

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Defect`>
...
* [constructor](_src_classclients_.classclients.defect.md#constructor)

### Properties

* [client](_src_classclients_.classclients.defect.md#client)
* [typeName](_src_classclients_.classclients.defect.md#typename)

### Methods

* [delete](_src_classclients_.classclients.defect.md#delete)
* [get](_src_classclients_.classclients.defect.md#get)
* [getCollection](_src_classclients_.classclients.defect.md#getcollection)
* [query](_src_classclients_.classclients.defect.md#query)
* [save](_src_classclients_.classclients.defect.md#save)
...
⊕ **new Defect**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Defect](_src_classclients_.classclients.defect.md)

⊕ **new Defect**(client: *[Client](_src_client_.client.md)*): [Defect](_src_classclients_.classclients.defect.md)
...
*Defined in [src/ClassClients.ts:242](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L242)*
...
**Returns:** [Defect](_src_classclients_.classclients.defect.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:243](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L243)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Defect`>
...
▸ **getCollection**(rallyObject: *`Defect`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Defect`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Defect`>>
...
▸ **save**(rallyObject: *`Partial`<`Defect`>*): `Promise`<`Defect`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Defect`> |  A new or existing Rally object |
