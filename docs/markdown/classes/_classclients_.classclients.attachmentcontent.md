[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [AttachmentContent](../classes/_classclients_.classclients.attachmentcontent.md)

# Class: AttachmentContent

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`AttachmentContent`>
...
* [constructor](_classclients_.classclients.attachmentcontent.md#constructor)

### Properties

* [client](_classclients_.classclients.attachmentcontent.md#client)
* [typeName](_classclients_.classclients.attachmentcontent.md#typename)

### Methods

* [delete](_classclients_.classclients.attachmentcontent.md#delete)
* [get](_classclients_.classclients.attachmentcontent.md#get)
* [getCollection](_classclients_.classclients.attachmentcontent.md#getcollection)
* [query](_classclients_.classclients.attachmentcontent.md#query)
* [save](_classclients_.classclients.attachmentcontent.md#save)
...
⊕ **new AttachmentContent**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [AttachmentContent](_classclients_.classclients.attachmentcontent.md)

⊕ **new AttachmentContent**(client: *[Client](_client_.client.md)*): [AttachmentContent](_classclients_.classclients.attachmentcontent.md)
...
*Defined in [ClassClients.ts:134](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L134)*
...
**Returns:** [AttachmentContent](_classclients_.classclients.attachmentcontent.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:135](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L135)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`AttachmentContent`>
...
▸ **getCollection**(rallyObject: *`AttachmentContent`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`AttachmentContent`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`AttachmentContent`>>
