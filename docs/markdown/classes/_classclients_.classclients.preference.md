[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Preference](../classes/_classclients_.classclients.preference.md)

# Class: Preference

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Preference`>
...
* [constructor](_classclients_.classclients.preference.md#constructor)

### Properties

* [client](_classclients_.classclients.preference.md#client)
* [typeName](_classclients_.classclients.preference.md#typename)

### Methods

* [delete](_classclients_.classclients.preference.md#delete)
* [get](_classclients_.classclients.preference.md#get)
* [getCollection](_classclients_.classclients.preference.md#getcollection)
* [query](_classclients_.classclients.preference.md#query)
* [save](_classclients_.classclients.preference.md#save)
...
⊕ **new Preference**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Preference](_classclients_.classclients.preference.md)

⊕ **new Preference**(client: *[Client](_client_.client.md)*): [Preference](_classclients_.classclients.preference.md)
...
*Defined in [ClassClients.ts:413](https://github.com/ferentchak/rally-node-sdk/blob/8064b9a/ClassClients.ts#L413)*
...
**Returns:** [Preference](_classclients_.classclients.preference.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:414](https://github.com/ferentchak/rally-node-sdk/blob/8064b9a/ClassClients.ts#L414)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Preference`>
...
▸ **getCollection**(rallyObject: *`Preference`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Preference`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Preference`>>
