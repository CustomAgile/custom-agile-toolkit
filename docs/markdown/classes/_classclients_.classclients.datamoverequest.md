[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [DataMoveRequest](../classes/_classclients_.classclients.datamoverequest.md)

# Class: DataMoveRequest

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`DataMoveRequest`>
...
* [constructor](_classclients_.classclients.datamoverequest.md#constructor)

### Properties

* [client](_classclients_.classclients.datamoverequest.md#client)
* [typeName](_classclients_.classclients.datamoverequest.md#typename)

### Methods

* [delete](_classclients_.classclients.datamoverequest.md#delete)
* [get](_classclients_.classclients.datamoverequest.md#get)
* [getCollection](_classclients_.classclients.datamoverequest.md#getcollection)
* [query](_classclients_.classclients.datamoverequest.md#query)
* [save](_classclients_.classclients.datamoverequest.md#save)
...
⊕ **new DataMoveRequest**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [DataMoveRequest](_classclients_.classclients.datamoverequest.md)

⊕ **new DataMoveRequest**(client: *[Client](_client_.client.md)*): [DataMoveRequest](_classclients_.classclients.datamoverequest.md)
...
*Defined in [ClassClients.ts:233](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L233)*
...
**Returns:** [DataMoveRequest](_classclients_.classclients.datamoverequest.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:234](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L234)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`DataMoveRequest`>
...
▸ **getCollection**(rallyObject: *`DataMoveRequest`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`DataMoveRequest`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`DataMoveRequest`>>
