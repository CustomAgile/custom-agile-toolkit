[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [IterationCumulativeFlowData](../classes/_src_classclients_.classclients.iterationcumulativeflowdata.md)

# Class: IterationCumulativeFlowData

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`IterationCumulativeFlowData`>
...
* [constructor](_src_classclients_.classclients.iterationcumulativeflowdata.md#constructor)

### Properties

* [client](_src_classclients_.classclients.iterationcumulativeflowdata.md#client)
* [typeName](_src_classclients_.classclients.iterationcumulativeflowdata.md#typename)

### Methods

* [delete](_src_classclients_.classclients.iterationcumulativeflowdata.md#delete)
* [get](_src_classclients_.classclients.iterationcumulativeflowdata.md#get)
* [getCollection](_src_classclients_.classclients.iterationcumulativeflowdata.md#getcollection)
* [query](_src_classclients_.classclients.iterationcumulativeflowdata.md#query)
* [save](_src_classclients_.classclients.iterationcumulativeflowdata.md#save)
...
⊕ **new IterationCumulativeFlowData**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [IterationCumulativeFlowData](_src_classclients_.classclients.iterationcumulativeflowdata.md)

⊕ **new IterationCumulativeFlowData**(client: *[Client](_src_client_.client.md)*): [IterationCumulativeFlowData](_src_classclients_.classclients.iterationcumulativeflowdata.md)
...
*Defined in [src/ClassClients.ts:341](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L341)*
...
**Returns:** [IterationCumulativeFlowData](_src_classclients_.classclients.iterationcumulativeflowdata.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:342](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L342)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`IterationCumulativeFlowData`>
...
▸ **getCollection**(rallyObject: *`IterationCumulativeFlowData`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`IterationCumulativeFlowData`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`IterationCumulativeFlowData`>>
