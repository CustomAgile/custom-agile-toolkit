[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [WebLinkDefinition](../classes/_src_classclients_.classclients.weblinkdefinition.md)

# Class: WebLinkDefinition

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`WebLinkDefinition`>
...
* [constructor](_src_classclients_.classclients.weblinkdefinition.md#constructor)

### Properties

* [client](_src_classclients_.classclients.weblinkdefinition.md#client)
* [typeName](_src_classclients_.classclients.weblinkdefinition.md#typename)

### Methods

* [delete](_src_classclients_.classclients.weblinkdefinition.md#delete)
* [get](_src_classclients_.classclients.weblinkdefinition.md#get)
* [getCollection](_src_classclients_.classclients.weblinkdefinition.md#getcollection)
* [query](_src_classclients_.classclients.weblinkdefinition.md#query)
* [save](_src_classclients_.classclients.weblinkdefinition.md#save)
...
⊕ **new WebLinkDefinition**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [WebLinkDefinition](_src_classclients_.classclients.weblinkdefinition.md)

⊕ **new WebLinkDefinition**(client: *[Client](_src_client_.client.md)*): [WebLinkDefinition](_src_classclients_.classclients.weblinkdefinition.md)
...
*Defined in [src/ClassClients.ts:755](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L755)*
...
**Returns:** [WebLinkDefinition](_src_classclients_.classclients.weblinkdefinition.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:756](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L756)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`WebLinkDefinition`>
...
**Returns:** `Promise`<`WebLinkDefinition`>
...
▸ **getCollection**(rallyObject: *`WebLinkDefinition`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`WebLinkDefinition`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`WebLinkDefinition`>>
...
▸ **save**(rallyObject: *`Partial`<`WebLinkDefinition`>*): `Promise`<`WebLinkDefinition`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`WebLinkDefinition`> |  A new or existing Rally object |
