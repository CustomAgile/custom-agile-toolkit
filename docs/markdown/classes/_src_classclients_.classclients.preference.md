[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Preference](../classes/_src_classclients_.classclients.preference.md)

# Class: Preference

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Preference`>
...
* [constructor](_src_classclients_.classclients.preference.md#constructor)

### Properties

* [client](_src_classclients_.classclients.preference.md#client)
* [typeName](_src_classclients_.classclients.preference.md#typename)

### Methods

* [delete](_src_classclients_.classclients.preference.md#delete)
* [get](_src_classclients_.classclients.preference.md#get)
* [getCollection](_src_classclients_.classclients.preference.md#getcollection)
* [query](_src_classclients_.classclients.preference.md#query)
* [save](_src_classclients_.classclients.preference.md#save)
...
⊕ **new Preference**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Preference](_src_classclients_.classclients.preference.md)

⊕ **new Preference**(client: *[Client](_src_client_.client.md)*): [Preference](_src_classclients_.classclients.preference.md)
...
*Defined in [src/ClassClients.ts:413](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L413)*
...
**Returns:** [Preference](_src_classclients_.classclients.preference.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:414](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L414)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Preference`>
...
▸ **getCollection**(rallyObject: *`Preference`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Preference`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Preference`>>
...
▸ **save**(rallyObject: *`Partial`<`Preference`>*): `Promise`<`Preference`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Preference`> |  A new or existing Rally object |
