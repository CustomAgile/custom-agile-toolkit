[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [UserProfile](../classes/_src_classclients_.classclients.userprofile.md)

# Class: UserProfile

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`UserProfile`>
...
* [constructor](_src_classclients_.classclients.userprofile.md#constructor)

### Properties

* [client](_src_classclients_.classclients.userprofile.md#client)
* [typeName](_src_classclients_.classclients.userprofile.md#typename)

### Methods

* [delete](_src_classclients_.classclients.userprofile.md#delete)
* [get](_src_classclients_.classclients.userprofile.md#get)
* [getCollection](_src_classclients_.classclients.userprofile.md#getcollection)
* [query](_src_classclients_.classclients.userprofile.md#query)
* [save](_src_classclients_.classclients.userprofile.md#save)
...
⊕ **new UserProfile**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [UserProfile](_src_classclients_.classclients.userprofile.md)

⊕ **new UserProfile**(client: *[Client](_src_client_.client.md)*): [UserProfile](_src_classclients_.classclients.userprofile.md)
...
*Defined in [src/ClassClients.ts:746](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L746)*
...
**Returns:** [UserProfile](_src_classclients_.classclients.userprofile.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:747](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L747)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`UserProfile`>
...
▸ **getCollection**(rallyObject: *`UserProfile`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`UserProfile`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`UserProfile`>>
...
▸ **save**(rallyObject: *`Partial`<`UserProfile`>*): `Promise`<`UserProfile`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`UserProfile`> |  A new or existing Rally object |
