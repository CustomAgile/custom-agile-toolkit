[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [PullRequest](../classes/_classclients_.classclients.pullrequest.md)

# Class: PullRequest

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`PullRequest`>
...
* [constructor](_classclients_.classclients.pullrequest.md#constructor)

### Properties

* [client](_classclients_.classclients.pullrequest.md#client)
* [typeName](_classclients_.classclients.pullrequest.md#typename)

### Methods

* [delete](_classclients_.classclients.pullrequest.md#delete)
* [get](_classclients_.classclients.pullrequest.md#get)
* [getCollection](_classclients_.classclients.pullrequest.md#getcollection)
* [query](_classclients_.classclients.pullrequest.md#query)
* [save](_classclients_.classclients.pullrequest.md#save)
...
⊕ **new PullRequest**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [PullRequest](_classclients_.classclients.pullrequest.md)

⊕ **new PullRequest**(client: *[Client](_client_.client.md)*): [PullRequest](_classclients_.classclients.pullrequest.md)
...
*Defined in [ClassClients.ts:458](https://github.com/ferentchak/rally-node-sdk/blob/8064b9a/ClassClients.ts#L458)*
...
**Returns:** [PullRequest](_classclients_.classclients.pullrequest.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:459](https://github.com/ferentchak/rally-node-sdk/blob/8064b9a/ClassClients.ts#L459)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`PullRequest`>
...
▸ **getCollection**(rallyObject: *`PullRequest`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`PullRequest`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`PullRequest`>>
