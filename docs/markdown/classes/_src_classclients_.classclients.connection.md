[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Connection](../classes/_src_classclients_.classclients.connection.md)

# Class: Connection

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Connection`>
...
* [constructor](_src_classclients_.classclients.connection.md#constructor)

### Properties

* [client](_src_classclients_.classclients.connection.md#client)
* [typeName](_src_classclients_.classclients.connection.md#typename)

### Methods

* [delete](_src_classclients_.classclients.connection.md#delete)
* [get](_src_classclients_.classclients.connection.md#get)
* [getCollection](_src_classclients_.classclients.connection.md#getcollection)
* [query](_src_classclients_.classclients.connection.md#query)
* [save](_src_classclients_.classclients.connection.md#save)
...
⊕ **new Connection**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Connection](_src_classclients_.classclients.connection.md)

⊕ **new Connection**(client: *[Client](_src_client_.client.md)*): [Connection](_src_classclients_.classclients.connection.md)
...
*Defined in [src/ClassClients.ts:197](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L197)*
...
**Returns:** [Connection](_src_classclients_.classclients.connection.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:198](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L198)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Connection`>
...
▸ **getCollection**(rallyObject: *`Connection`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Connection`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Connection`>>
...
▸ **save**(rallyObject: *`Partial`<`Connection`>*): `Promise`<`Connection`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Connection`> |  A new or existing Rally object |
