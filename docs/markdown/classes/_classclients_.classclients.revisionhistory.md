[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [RevisionHistory](../classes/_classclients_.classclients.revisionhistory.md)

# Class: RevisionHistory

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`RevisionHistory`>
...
* [constructor](_classclients_.classclients.revisionhistory.md#constructor)

### Properties

* [client](_classclients_.classclients.revisionhistory.md#client)
* [typeName](_classclients_.classclients.revisionhistory.md#typename)

### Methods

* [delete](_classclients_.classclients.revisionhistory.md#delete)
* [get](_classclients_.classclients.revisionhistory.md#get)
* [getCollection](_classclients_.classclients.revisionhistory.md#getcollection)
* [query](_classclients_.classclients.revisionhistory.md#query)
* [save](_classclients_.classclients.revisionhistory.md#save)
...
⊕ **new RevisionHistory**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [RevisionHistory](_classclients_.classclients.revisionhistory.md)

⊕ **new RevisionHistory**(client: *[Client](_client_.client.md)*): [RevisionHistory](_classclients_.classclients.revisionhistory.md)
...
*Defined in [ClassClients.ts:521](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L521)*
...
**Returns:** [RevisionHistory](_classclients_.classclients.revisionhistory.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:522](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L522)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`RevisionHistory`>
...
▸ **getCollection**(rallyObject: *`RevisionHistory`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`RevisionHistory`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`RevisionHistory`>>
