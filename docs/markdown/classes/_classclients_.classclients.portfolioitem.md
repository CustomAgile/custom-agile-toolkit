[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [PortfolioItem](../classes/_classclients_.classclients.portfolioitem.md)

# Class: PortfolioItem

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`PortfolioItem`>
...
* [constructor](_classclients_.classclients.portfolioitem.md#constructor)

### Properties

* [client](_classclients_.classclients.portfolioitem.md#client)
* [typeName](_classclients_.classclients.portfolioitem.md#typename)

### Methods

* [delete](_classclients_.classclients.portfolioitem.md#delete)
* [get](_classclients_.classclients.portfolioitem.md#get)
* [getCollection](_classclients_.classclients.portfolioitem.md#getcollection)
* [query](_classclients_.classclients.portfolioitem.md#query)
* [save](_classclients_.classclients.portfolioitem.md#save)
...
⊕ **new PortfolioItem**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [PortfolioItem](_classclients_.classclients.portfolioitem.md)

⊕ **new PortfolioItem**(client: *[Client](_client_.client.md)*): [PortfolioItem](_classclients_.classclients.portfolioitem.md)
...
*Defined in [ClassClients.ts:395](https://github.com/ferentchak/rally-node-sdk/blob/45aae0f/ClassClients.ts#L395)*
...
**Returns:** [PortfolioItem](_classclients_.classclients.portfolioitem.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:396](https://github.com/ferentchak/rally-node-sdk/blob/45aae0f/ClassClients.ts#L396)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`PortfolioItem`>
...
▸ **getCollection**(rallyObject: *`PortfolioItem`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`PortfolioItem`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`PortfolioItem`>>
