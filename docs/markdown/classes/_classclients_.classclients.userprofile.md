[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [UserProfile](../classes/_classclients_.classclients.userprofile.md)

# Class: UserProfile

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`UserProfile`>
...
* [constructor](_classclients_.classclients.userprofile.md#constructor)

### Properties

* [client](_classclients_.classclients.userprofile.md#client)
* [typeName](_classclients_.classclients.userprofile.md#typename)

### Methods

* [delete](_classclients_.classclients.userprofile.md#delete)
* [get](_classclients_.classclients.userprofile.md#get)
* [getCollection](_classclients_.classclients.userprofile.md#getcollection)
* [query](_classclients_.classclients.userprofile.md#query)
* [save](_classclients_.classclients.userprofile.md#save)
...
⊕ **new UserProfile**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [UserProfile](_classclients_.classclients.userprofile.md)

⊕ **new UserProfile**(client: *[Client](_client_.client.md)*): [UserProfile](_classclients_.classclients.userprofile.md)
...
*Defined in [ClassClients.ts:746](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L746)*
...
**Returns:** [UserProfile](_classclients_.classclients.userprofile.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:747](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L747)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`UserProfile`>
...
▸ **getCollection**(rallyObject: *`UserProfile`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`UserProfile`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`UserProfile`>>
