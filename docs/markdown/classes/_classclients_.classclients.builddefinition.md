[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [BuildDefinition](../classes/_classclients_.classclients.builddefinition.md)

# Class: BuildDefinition

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`BuildDefinition`>
...
* [constructor](_classclients_.classclients.builddefinition.md#constructor)

### Properties

* [client](_classclients_.classclients.builddefinition.md#client)
* [typeName](_classclients_.classclients.builddefinition.md#typename)

### Methods

* [delete](_classclients_.classclients.builddefinition.md#delete)
* [get](_classclients_.classclients.builddefinition.md#get)
* [getCollection](_classclients_.classclients.builddefinition.md#getcollection)
* [query](_classclients_.classclients.builddefinition.md#query)
* [save](_classclients_.classclients.builddefinition.md#save)
...
⊕ **new BuildDefinition**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [BuildDefinition](_classclients_.classclients.builddefinition.md)

⊕ **new BuildDefinition**(client: *[Client](_client_.client.md)*): [BuildDefinition](_classclients_.classclients.builddefinition.md)
...
*Defined in [ClassClients.ts:170](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L170)*
...
**Returns:** [BuildDefinition](_classclients_.classclients.builddefinition.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:171](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L171)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`BuildDefinition`>
...
▸ **getCollection**(rallyObject: *`BuildDefinition`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`BuildDefinition`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`BuildDefinition`>>
