[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Feature](../classes/_classclients_.classclients.feature.md)

# Class: Feature

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Feature`>
...
* [constructor](_classclients_.classclients.feature.md#constructor)

### Properties

* [client](_classclients_.classclients.feature.md#client)
* [typeName](_classclients_.classclients.feature.md#typename)

### Methods

* [delete](_classclients_.classclients.feature.md#delete)
* [get](_classclients_.classclients.feature.md#get)
* [getCollection](_classclients_.classclients.feature.md#getcollection)
* [query](_classclients_.classclients.feature.md#query)
* [save](_classclients_.classclients.feature.md#save)
...
⊕ **new Feature**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Feature](_classclients_.classclients.feature.md)

⊕ **new Feature**(client: *[Client](_client_.client.md)*): [Feature](_classclients_.classclients.feature.md)
...
*Defined in [ClassClients.ts:269](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L269)*
...
**Returns:** [Feature](_classclients_.classclients.feature.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:270](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L270)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Feature`>
...
▸ **getCollection**(rallyObject: *`Feature`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Feature`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Feature`>>
