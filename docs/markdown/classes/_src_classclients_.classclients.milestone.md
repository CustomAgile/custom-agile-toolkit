[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Milestone](../classes/_src_classclients_.classclients.milestone.md)

# Class: Milestone

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Milestone`>
...
* [constructor](_src_classclients_.classclients.milestone.md#constructor)

### Properties

* [client](_src_classclients_.classclients.milestone.md#client)
* [typeName](_src_classclients_.classclients.milestone.md#typename)

### Methods

* [delete](_src_classclients_.classclients.milestone.md#delete)
* [get](_src_classclients_.classclients.milestone.md#get)
* [getCollection](_src_classclients_.classclients.milestone.md#getcollection)
* [query](_src_classclients_.classclients.milestone.md#query)
* [save](_src_classclients_.classclients.milestone.md#save)
...
⊕ **new Milestone**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Milestone](_src_classclients_.classclients.milestone.md)

⊕ **new Milestone**(client: *[Client](_src_client_.client.md)*): [Milestone](_src_classclients_.classclients.milestone.md)
...
*Defined in [src/ClassClients.ts:350](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L350)*
...
**Returns:** [Milestone](_src_classclients_.classclients.milestone.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:351](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L351)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Milestone`>
...
▸ **getCollection**(rallyObject: *`Milestone`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Milestone`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Milestone`>>
