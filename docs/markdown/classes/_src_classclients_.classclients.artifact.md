[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Artifact](../classes/_src_classclients_.classclients.artifact.md)

# Class: Artifact

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Artifact`>
...
* [constructor](_src_classclients_.classclients.artifact.md#constructor)

### Properties

* [client](_src_classclients_.classclients.artifact.md#client)
* [typeName](_src_classclients_.classclients.artifact.md#typename)

### Methods

* [delete](_src_classclients_.classclients.artifact.md#delete)
* [get](_src_classclients_.classclients.artifact.md#get)
* [getCollection](_src_classclients_.classclients.artifact.md#getcollection)
* [query](_src_classclients_.classclients.artifact.md#query)
* [save](_src_classclients_.classclients.artifact.md#save)
...
⊕ **new Artifact**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Artifact](_src_classclients_.classclients.artifact.md)

⊕ **new Artifact**(client: *[Client](_src_client_.client.md)*): [Artifact](_src_classclients_.classclients.artifact.md)
...
*Defined in [src/ClassClients.ts:107](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L107)*
...
**Returns:** [Artifact](_src_classclients_.classclients.artifact.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:108](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L108)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Artifact`>
...
▸ **getCollection**(rallyObject: *`Artifact`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Artifact`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Artifact`>>
...
▸ **save**(rallyObject: *`Partial`<`Artifact`>*): `Promise`<`Artifact`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Artifact`> |  A new or existing Rally object |
