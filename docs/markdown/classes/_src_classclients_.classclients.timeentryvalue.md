[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [TimeEntryValue](../classes/_src_classclients_.classclients.timeentryvalue.md)

# Class: TimeEntryValue

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`TimeEntryValue`>
...
* [constructor](_src_classclients_.classclients.timeentryvalue.md#constructor)

### Properties

* [client](_src_classclients_.classclients.timeentryvalue.md#client)
* [typeName](_src_classclients_.classclients.timeentryvalue.md#typename)

### Methods

* [delete](_src_classclients_.classclients.timeentryvalue.md#delete)
* [get](_src_classclients_.classclients.timeentryvalue.md#get)
* [getCollection](_src_classclients_.classclients.timeentryvalue.md#getcollection)
* [query](_src_classclients_.classclients.timeentryvalue.md#query)
* [save](_src_classclients_.classclients.timeentryvalue.md#save)
...
⊕ **new TimeEntryValue**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [TimeEntryValue](_src_classclients_.classclients.timeentryvalue.md)

⊕ **new TimeEntryValue**(client: *[Client](_src_client_.client.md)*): [TimeEntryValue](_src_classclients_.classclients.timeentryvalue.md)
...
*Defined in [src/ClassClients.ts:701](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L701)*
...
**Returns:** [TimeEntryValue](_src_classclients_.classclients.timeentryvalue.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:702](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L702)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`TimeEntryValue`>
...
▸ **getCollection**(rallyObject: *`TimeEntryValue`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TimeEntryValue`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TimeEntryValue`>>
