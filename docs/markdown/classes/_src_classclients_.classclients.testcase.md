[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [TestCase](../classes/_src_classclients_.classclients.testcase.md)

# Class: TestCase

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`TestCase`>
...
* [constructor](_src_classclients_.classclients.testcase.md#constructor)

### Properties

* [client](_src_classclients_.classclients.testcase.md#client)
* [typeName](_src_classclients_.classclients.testcase.md#typename)

### Methods

* [delete](_src_classclients_.classclients.testcase.md#delete)
* [get](_src_classclients_.classclients.testcase.md#get)
* [getCollection](_src_classclients_.classclients.testcase.md#getcollection)
* [query](_src_classclients_.classclients.testcase.md#query)
* [save](_src_classclients_.classclients.testcase.md#save)
...
⊕ **new TestCase**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [TestCase](_src_classclients_.classclients.testcase.md)

⊕ **new TestCase**(client: *[Client](_src_client_.client.md)*): [TestCase](_src_classclients_.classclients.testcase.md)
...
*Defined in [src/ClassClients.ts:638](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L638)*
...
**Returns:** [TestCase](_src_classclients_.classclients.testcase.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:639](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L639)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`TestCase`>
...
▸ **getCollection**(rallyObject: *`TestCase`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TestCase`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TestCase`>>
...
▸ **save**(rallyObject: *`Partial`<`TestCase`>*): `Promise`<`TestCase`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`TestCase`> |  A new or existing Rally object |
