[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Scope](../classes/_src_classclients_.classclients.scope.md)

# Class: Scope

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Scope`>
...
* [constructor](_src_classclients_.classclients.scope.md#constructor)

### Properties

* [client](_src_classclients_.classclients.scope.md#client)
* [typeName](_src_classclients_.classclients.scope.md#typename)

### Methods

* [delete](_src_classclients_.classclients.scope.md#delete)
* [get](_src_classclients_.classclients.scope.md#get)
* [getCollection](_src_classclients_.classclients.scope.md#getcollection)
* [query](_src_classclients_.classclients.scope.md#query)
* [save](_src_classclients_.classclients.scope.md#save)
...
⊕ **new Scope**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Scope](_src_classclients_.classclients.scope.md)

⊕ **new Scope**(client: *[Client](_src_client_.client.md)*): [Scope](_src_classclients_.classclients.scope.md)
...
*Defined in [src/ClassClients.ts:566](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L566)*
...
**Returns:** [Scope](_src_classclients_.classclients.scope.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:567](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L567)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Scope`>
...
▸ **getCollection**(rallyObject: *`Scope`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Scope`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Scope`>>
