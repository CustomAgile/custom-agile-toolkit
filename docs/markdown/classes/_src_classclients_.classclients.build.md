[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Build](../classes/_src_classclients_.classclients.build.md)

# Class: Build

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Build`>
...
* [constructor](_src_classclients_.classclients.build.md#constructor)

### Properties

* [client](_src_classclients_.classclients.build.md#client)
* [typeName](_src_classclients_.classclients.build.md#typename)

### Methods

* [delete](_src_classclients_.classclients.build.md#delete)
* [get](_src_classclients_.classclients.build.md#get)
* [getCollection](_src_classclients_.classclients.build.md#getcollection)
* [query](_src_classclients_.classclients.build.md#query)
* [save](_src_classclients_.classclients.build.md#save)
...
⊕ **new Build**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Build](_src_classclients_.classclients.build.md)

⊕ **new Build**(client: *[Client](_src_client_.client.md)*): [Build](_src_classclients_.classclients.build.md)
...
*Defined in [src/ClassClients.ts:161](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L161)*
...
**Returns:** [Build](_src_classclients_.classclients.build.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:162](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L162)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Build`>
...
▸ **getCollection**(rallyObject: *`Build`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Build`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Build`>>
