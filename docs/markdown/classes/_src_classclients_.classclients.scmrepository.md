[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [SCMRepository](../classes/_src_classclients_.classclients.scmrepository.md)

# Class: SCMRepository

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`SCMRepository`>
...
* [constructor](_src_classclients_.classclients.scmrepository.md#constructor)

### Properties

* [client](_src_classclients_.classclients.scmrepository.md#client)
* [typeName](_src_classclients_.classclients.scmrepository.md#typename)

### Methods

* [delete](_src_classclients_.classclients.scmrepository.md#delete)
* [get](_src_classclients_.classclients.scmrepository.md#get)
* [getCollection](_src_classclients_.classclients.scmrepository.md#getcollection)
* [query](_src_classclients_.classclients.scmrepository.md#query)
* [save](_src_classclients_.classclients.scmrepository.md#save)
...
⊕ **new SCMRepository**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [SCMRepository](_src_classclients_.classclients.scmrepository.md)

⊕ **new SCMRepository**(client: *[Client](_src_client_.client.md)*): [SCMRepository](_src_classclients_.classclients.scmrepository.md)
...
*Defined in [src/ClassClients.ts:539](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L539)*
...
**Returns:** [SCMRepository](_src_classclients_.classclients.scmrepository.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:540](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L540)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`SCMRepository`>
...
▸ **getCollection**(rallyObject: *`SCMRepository`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`SCMRepository`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`SCMRepository`>>
...
▸ **save**(rallyObject: *`Partial`<`SCMRepository`>*): `Promise`<`SCMRepository`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`SCMRepository`> |  A new or existing Rally object |
