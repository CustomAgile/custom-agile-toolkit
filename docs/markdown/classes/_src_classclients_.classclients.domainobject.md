[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [DomainObject](../classes/_src_classclients_.classclients.domainobject.md)

# Class: DomainObject

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`DomainObject`>
...
* [constructor](_src_classclients_.classclients.domainobject.md#constructor)

### Properties

* [client](_src_classclients_.classclients.domainobject.md#client)
* [typeName](_src_classclients_.classclients.domainobject.md#typename)

### Methods

* [delete](_src_classclients_.classclients.domainobject.md#delete)
* [get](_src_classclients_.classclients.domainobject.md#get)
* [getCollection](_src_classclients_.classclients.domainobject.md#getcollection)
* [query](_src_classclients_.classclients.domainobject.md#query)
* [save](_src_classclients_.classclients.domainobject.md#save)
...
⊕ **new DomainObject**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [DomainObject](_src_classclients_.classclients.domainobject.md)

⊕ **new DomainObject**(client: *[Client](_src_client_.client.md)*): [DomainObject](_src_classclients_.classclients.domainobject.md)
...
*Defined in [src/ClassClients.ts:260](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L260)*
...
**Returns:** [DomainObject](_src_classclients_.classclients.domainobject.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:261](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L261)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`DomainObject`>
...
▸ **getCollection**(rallyObject: *`DomainObject`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`DomainObject`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`DomainObject`>>
...
▸ **save**(rallyObject: *`Partial`<`DomainObject`>*): `Promise`<`DomainObject`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`DomainObject`> |  A new or existing Rally object |
