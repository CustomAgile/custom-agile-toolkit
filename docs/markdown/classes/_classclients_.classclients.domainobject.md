[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [DomainObject](../classes/_classclients_.classclients.domainobject.md)

# Class: DomainObject

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`DomainObject`>
...
* [constructor](_classclients_.classclients.domainobject.md#constructor)

### Properties

* [client](_classclients_.classclients.domainobject.md#client)
* [typeName](_classclients_.classclients.domainobject.md#typename)

### Methods

* [delete](_classclients_.classclients.domainobject.md#delete)
* [get](_classclients_.classclients.domainobject.md#get)
* [getCollection](_classclients_.classclients.domainobject.md#getcollection)
* [query](_classclients_.classclients.domainobject.md#query)
* [save](_classclients_.classclients.domainobject.md#save)
...
⊕ **new DomainObject**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [DomainObject](_classclients_.classclients.domainobject.md)

⊕ **new DomainObject**(client: *[Client](_client_.client.md)*): [DomainObject](_classclients_.classclients.domainobject.md)
...
*Defined in [ClassClients.ts:260](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L260)*
...
**Returns:** [DomainObject](_classclients_.classclients.domainobject.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:261](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L261)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`DomainObject`>
...
▸ **getCollection**(rallyObject: *`DomainObject`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`DomainObject`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`DomainObject`>>
