[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [TestCase](../classes/_classclients_.classclients.testcase.md)

# Class: TestCase

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`TestCase`>
...
* [constructor](_classclients_.classclients.testcase.md#constructor)

### Properties

* [client](_classclients_.classclients.testcase.md#client)
* [typeName](_classclients_.classclients.testcase.md#typename)

### Methods

* [delete](_classclients_.classclients.testcase.md#delete)
* [get](_classclients_.classclients.testcase.md#get)
* [getCollection](_classclients_.classclients.testcase.md#getcollection)
* [query](_classclients_.classclients.testcase.md#query)
* [save](_classclients_.classclients.testcase.md#save)
...
⊕ **new TestCase**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [TestCase](_classclients_.classclients.testcase.md)

⊕ **new TestCase**(client: *[Client](_client_.client.md)*): [TestCase](_classclients_.classclients.testcase.md)
...
*Defined in [ClassClients.ts:638](https://github.com/ferentchak/rally-node-sdk/blob/8064b9a/ClassClients.ts#L638)*
...
**Returns:** [TestCase](_classclients_.classclients.testcase.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:639](https://github.com/ferentchak/rally-node-sdk/blob/8064b9a/ClassClients.ts#L639)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`TestCase`>
...
▸ **getCollection**(rallyObject: *`TestCase`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TestCase`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TestCase`>>
