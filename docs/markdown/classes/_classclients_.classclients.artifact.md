[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Artifact](../classes/_classclients_.classclients.artifact.md)

# Class: Artifact

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Artifact`>
...
* [constructor](_classclients_.classclients.artifact.md#constructor)

### Properties

* [client](_classclients_.classclients.artifact.md#client)
* [typeName](_classclients_.classclients.artifact.md#typename)

### Methods

* [delete](_classclients_.classclients.artifact.md#delete)
* [get](_classclients_.classclients.artifact.md#get)
* [getCollection](_classclients_.classclients.artifact.md#getcollection)
* [query](_classclients_.classclients.artifact.md#query)
* [save](_classclients_.classclients.artifact.md#save)
...
⊕ **new Artifact**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Artifact](_classclients_.classclients.artifact.md)

⊕ **new Artifact**(client: *[Client](_client_.client.md)*): [Artifact](_classclients_.classclients.artifact.md)
...
*Defined in [ClassClients.ts:107](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L107)*
...
**Returns:** [Artifact](_classclients_.classclients.artifact.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:108](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L108)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Artifact`>
...
▸ **getCollection**(rallyObject: *`Artifact`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Artifact`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Artifact`>>
