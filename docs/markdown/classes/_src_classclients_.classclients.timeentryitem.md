[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [TimeEntryItem](../classes/_src_classclients_.classclients.timeentryitem.md)

# Class: TimeEntryItem

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`TimeEntryItem`>
...
* [constructor](_src_classclients_.classclients.timeentryitem.md#constructor)

### Properties

* [client](_src_classclients_.classclients.timeentryitem.md#client)
* [typeName](_src_classclients_.classclients.timeentryitem.md#typename)

### Methods

* [delete](_src_classclients_.classclients.timeentryitem.md#delete)
* [get](_src_classclients_.classclients.timeentryitem.md#get)
* [getCollection](_src_classclients_.classclients.timeentryitem.md#getcollection)
* [query](_src_classclients_.classclients.timeentryitem.md#query)
* [save](_src_classclients_.classclients.timeentryitem.md#save)
...
⊕ **new TimeEntryItem**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [TimeEntryItem](_src_classclients_.classclients.timeentryitem.md)

⊕ **new TimeEntryItem**(client: *[Client](_src_client_.client.md)*): [TimeEntryItem](_src_classclients_.classclients.timeentryitem.md)
...
*Defined in [src/ClassClients.ts:692](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L692)*
...
**Returns:** [TimeEntryItem](_src_classclients_.classclients.timeentryitem.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:693](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L693)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`TimeEntryItem`>
...
▸ **getCollection**(rallyObject: *`TimeEntryItem`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TimeEntryItem`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TimeEntryItem`>>
...
▸ **save**(rallyObject: *`Partial`<`TimeEntryItem`>*): `Promise`<`TimeEntryItem`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`TimeEntryItem`> |  A new or existing Rally object |
