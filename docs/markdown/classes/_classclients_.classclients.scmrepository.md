[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [SCMRepository](../classes/_classclients_.classclients.scmrepository.md)

# Class: SCMRepository

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`SCMRepository`>
...
* [constructor](_classclients_.classclients.scmrepository.md#constructor)

### Properties

* [client](_classclients_.classclients.scmrepository.md#client)
* [typeName](_classclients_.classclients.scmrepository.md#typename)

### Methods

* [delete](_classclients_.classclients.scmrepository.md#delete)
* [get](_classclients_.classclients.scmrepository.md#get)
* [getCollection](_classclients_.classclients.scmrepository.md#getcollection)
* [query](_classclients_.classclients.scmrepository.md#query)
* [save](_classclients_.classclients.scmrepository.md#save)
...
⊕ **new SCMRepository**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [SCMRepository](_classclients_.classclients.scmrepository.md)

⊕ **new SCMRepository**(client: *[Client](_client_.client.md)*): [SCMRepository](_classclients_.classclients.scmrepository.md)
...
*Defined in [ClassClients.ts:539](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L539)*
...
**Returns:** [SCMRepository](_classclients_.classclients.scmrepository.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:540](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L540)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`SCMRepository`>
...
▸ **getCollection**(rallyObject: *`SCMRepository`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`SCMRepository`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`SCMRepository`>>
