[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [PPMConnection](../classes/_classclients_.classclients.ppmconnection.md)

# Class: PPMConnection

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`PPMConnection`>
...
* [constructor](_classclients_.classclients.ppmconnection.md#constructor)

### Properties

* [client](_classclients_.classclients.ppmconnection.md#client)
* [typeName](_classclients_.classclients.ppmconnection.md#typename)

### Methods

* [delete](_classclients_.classclients.ppmconnection.md#delete)
* [get](_classclients_.classclients.ppmconnection.md#get)
* [getCollection](_classclients_.classclients.ppmconnection.md#getcollection)
* [query](_classclients_.classclients.ppmconnection.md#query)
* [save](_classclients_.classclients.ppmconnection.md#save)
...
⊕ **new PPMConnection**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [PPMConnection](_classclients_.classclients.ppmconnection.md)

⊕ **new PPMConnection**(client: *[Client](_client_.client.md)*): [PPMConnection](_classclients_.classclients.ppmconnection.md)
...
*Defined in [ClassClients.ts:359](https://github.com/ferentchak/rally-node-sdk/blob/88a0ac6/ClassClients.ts#L359)*
...
**Returns:** [PPMConnection](_classclients_.classclients.ppmconnection.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:360](https://github.com/ferentchak/rally-node-sdk/blob/88a0ac6/ClassClients.ts#L360)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`PPMConnection`>
...
▸ **getCollection**(rallyObject: *`PPMConnection`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`PPMConnection`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`PPMConnection`>>
