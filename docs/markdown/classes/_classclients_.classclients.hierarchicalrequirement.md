[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [HierarchicalRequirement](../classes/_classclients_.classclients.hierarchicalrequirement.md)

# Class: HierarchicalRequirement

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`HierarchicalRequirement`>
...
* [constructor](_classclients_.classclients.hierarchicalrequirement.md#constructor)

### Properties

* [client](_classclients_.classclients.hierarchicalrequirement.md#client)
* [typeName](_classclients_.classclients.hierarchicalrequirement.md#typename)

### Methods

* [delete](_classclients_.classclients.hierarchicalrequirement.md#delete)
* [get](_classclients_.classclients.hierarchicalrequirement.md#get)
* [getCollection](_classclients_.classclients.hierarchicalrequirement.md#getcollection)
* [query](_classclients_.classclients.hierarchicalrequirement.md#query)
* [save](_classclients_.classclients.hierarchicalrequirement.md#save)
...
⊕ **new HierarchicalRequirement**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [HierarchicalRequirement](_classclients_.classclients.hierarchicalrequirement.md)

⊕ **new HierarchicalRequirement**(client: *[Client](_client_.client.md)*): [HierarchicalRequirement](_classclients_.classclients.hierarchicalrequirement.md)
...
*Defined in [ClassClients.ts:296](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L296)*
...
**Returns:** [HierarchicalRequirement](_classclients_.classclients.hierarchicalrequirement.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:297](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L297)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`HierarchicalRequirement`>
...
▸ **getCollection**(rallyObject: *`HierarchicalRequirement`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`HierarchicalRequirement`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`HierarchicalRequirement`>>
