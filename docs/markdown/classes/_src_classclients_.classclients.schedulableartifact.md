[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [SchedulableArtifact](../classes/_src_classclients_.classclients.schedulableartifact.md)

# Class: SchedulableArtifact

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`SchedulableArtifact`>
...
* [constructor](_src_classclients_.classclients.schedulableartifact.md#constructor)

### Properties

* [client](_src_classclients_.classclients.schedulableartifact.md#client)
* [typeName](_src_classclients_.classclients.schedulableartifact.md#typename)

### Methods

* [delete](_src_classclients_.classclients.schedulableartifact.md#delete)
* [get](_src_classclients_.classclients.schedulableartifact.md#get)
* [getCollection](_src_classclients_.classclients.schedulableartifact.md#getcollection)
* [query](_src_classclients_.classclients.schedulableartifact.md#query)
* [save](_src_classclients_.classclients.schedulableartifact.md#save)
...
⊕ **new SchedulableArtifact**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [SchedulableArtifact](_src_classclients_.classclients.schedulableartifact.md)

⊕ **new SchedulableArtifact**(client: *[Client](_src_client_.client.md)*): [SchedulableArtifact](_src_classclients_.classclients.schedulableartifact.md)
...
*Defined in [src/ClassClients.ts:548](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L548)*
...
**Returns:** [SchedulableArtifact](_src_classclients_.classclients.schedulableartifact.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:549](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L549)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`SchedulableArtifact`>
...
▸ **getCollection**(rallyObject: *`SchedulableArtifact`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`SchedulableArtifact`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`SchedulableArtifact`>>
