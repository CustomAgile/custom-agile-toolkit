[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Iteration](../classes/_classclients_.classclients.iteration.md)

# Class: Iteration

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Iteration`>
...
* [constructor](_classclients_.classclients.iteration.md#constructor)

### Properties

* [client](_classclients_.classclients.iteration.md#client)
* [typeName](_classclients_.classclients.iteration.md#typename)

### Methods

* [delete](_classclients_.classclients.iteration.md#delete)
* [get](_classclients_.classclients.iteration.md#get)
* [getCollection](_classclients_.classclients.iteration.md#getcollection)
* [query](_classclients_.classclients.iteration.md#query)
* [save](_classclients_.classclients.iteration.md#save)
...
⊕ **new Iteration**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Iteration](_classclients_.classclients.iteration.md)

⊕ **new Iteration**(client: *[Client](_client_.client.md)*): [Iteration](_classclients_.classclients.iteration.md)
...
*Defined in [ClassClients.ts:332](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L332)*
...
**Returns:** [Iteration](_classclients_.classclients.iteration.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:333](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L333)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Iteration`>
...
▸ **getCollection**(rallyObject: *`Iteration`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Iteration`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Iteration`>>
