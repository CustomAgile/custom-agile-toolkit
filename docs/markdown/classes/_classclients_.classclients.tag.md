[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Tag](../classes/_classclients_.classclients.tag.md)

# Class: Tag

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Tag`>
...
* [constructor](_classclients_.classclients.tag.md#constructor)

### Properties

* [client](_classclients_.classclients.tag.md#client)
* [typeName](_classclients_.classclients.tag.md#typename)

### Methods

* [delete](_classclients_.classclients.tag.md#delete)
* [get](_classclients_.classclients.tag.md#get)
* [getCollection](_classclients_.classclients.tag.md#getcollection)
* [query](_classclients_.classclients.tag.md#query)
* [save](_classclients_.classclients.tag.md#save)
...
⊕ **new Tag**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Tag](_classclients_.classclients.tag.md)

⊕ **new Tag**(client: *[Client](_client_.client.md)*): [Tag](_classclients_.classclients.tag.md)
...
*Defined in [ClassClients.ts:620](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L620)*
...
**Returns:** [Tag](_classclients_.classclients.tag.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:621](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L621)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Tag`>
...
▸ **getCollection**(rallyObject: *`Tag`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Tag`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Tag`>>
