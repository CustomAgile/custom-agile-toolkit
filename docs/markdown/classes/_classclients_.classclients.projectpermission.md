[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [ProjectPermission](../classes/_classclients_.classclients.projectpermission.md)

# Class: ProjectPermission

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`ProjectPermission`>
...
* [constructor](_classclients_.classclients.projectpermission.md#constructor)

### Properties

* [client](_classclients_.classclients.projectpermission.md#client)
* [typeName](_classclients_.classclients.projectpermission.md#typename)

### Methods

* [delete](_classclients_.classclients.projectpermission.md#delete)
* [get](_classclients_.classclients.projectpermission.md#get)
* [getCollection](_classclients_.classclients.projectpermission.md#getcollection)
* [query](_classclients_.classclients.projectpermission.md#query)
* [save](_classclients_.classclients.projectpermission.md#save)
...
⊕ **new ProjectPermission**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [ProjectPermission](_classclients_.classclients.projectpermission.md)

⊕ **new ProjectPermission**(client: *[Client](_client_.client.md)*): [ProjectPermission](_classclients_.classclients.projectpermission.md)
...
*Defined in [ClassClients.ts:449](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L449)*
...
**Returns:** [ProjectPermission](_classclients_.classclients.projectpermission.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:450](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L450)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`ProjectPermission`>
...
▸ **getCollection**(rallyObject: *`ProjectPermission`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`ProjectPermission`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`ProjectPermission`>>
