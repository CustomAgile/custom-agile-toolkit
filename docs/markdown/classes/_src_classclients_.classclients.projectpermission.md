[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [ProjectPermission](../classes/_src_classclients_.classclients.projectpermission.md)

# Class: ProjectPermission

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`ProjectPermission`>
...
* [constructor](_src_classclients_.classclients.projectpermission.md#constructor)

### Properties

* [client](_src_classclients_.classclients.projectpermission.md#client)
* [typeName](_src_classclients_.classclients.projectpermission.md#typename)

### Methods

* [delete](_src_classclients_.classclients.projectpermission.md#delete)
* [get](_src_classclients_.classclients.projectpermission.md#get)
* [getCollection](_src_classclients_.classclients.projectpermission.md#getcollection)
* [query](_src_classclients_.classclients.projectpermission.md#query)
* [save](_src_classclients_.classclients.projectpermission.md#save)
...
⊕ **new ProjectPermission**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [ProjectPermission](_src_classclients_.classclients.projectpermission.md)

⊕ **new ProjectPermission**(client: *[Client](_src_client_.client.md)*): [ProjectPermission](_src_classclients_.classclients.projectpermission.md)
...
*Defined in [src/ClassClients.ts:449](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L449)*
...
**Returns:** [ProjectPermission](_src_classclients_.classclients.projectpermission.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:450](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L450)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`ProjectPermission`>
...
**Returns:** `Promise`<`ProjectPermission`>
...
▸ **getCollection**(rallyObject: *`ProjectPermission`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`ProjectPermission`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`ProjectPermission`>>
...
▸ **save**(rallyObject: *`Partial`<`ProjectPermission`>*): `Promise`<`ProjectPermission`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`ProjectPermission`> |  A new or existing Rally object |
