[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [TestSet](../classes/_src_classclients_.classclients.testset.md)

# Class: TestSet

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`TestSet`>
...
* [constructor](_src_classclients_.classclients.testset.md#constructor)

### Properties

* [client](_src_classclients_.classclients.testset.md#client)
* [typeName](_src_classclients_.classclients.testset.md#typename)

### Methods

* [delete](_src_classclients_.classclients.testset.md#delete)
* [get](_src_classclients_.classclients.testset.md#get)
* [getCollection](_src_classclients_.classclients.testset.md#getcollection)
* [query](_src_classclients_.classclients.testset.md#query)
* [save](_src_classclients_.classclients.testset.md#save)
...
⊕ **new TestSet**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [TestSet](_src_classclients_.classclients.testset.md)

⊕ **new TestSet**(client: *[Client](_src_client_.client.md)*): [TestSet](_src_classclients_.classclients.testset.md)
...
*Defined in [src/ClassClients.ts:683](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L683)*
...
**Returns:** [TestSet](_src_classclients_.classclients.testset.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:684](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L684)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`TestSet`>
...
▸ **getCollection**(rallyObject: *`TestSet`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TestSet`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TestSet`>>
