[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Attachment](../classes/_classclients_.classclients.attachment.md)

# Class: Attachment

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Attachment`>
...
* [constructor](_classclients_.classclients.attachment.md#constructor)

### Properties

* [client](_classclients_.classclients.attachment.md#client)
* [typeName](_classclients_.classclients.attachment.md#typename)

### Methods

* [delete](_classclients_.classclients.attachment.md#delete)
* [get](_classclients_.classclients.attachment.md#get)
* [getCollection](_classclients_.classclients.attachment.md#getcollection)
* [query](_classclients_.classclients.attachment.md#query)
* [save](_classclients_.classclients.attachment.md#save)
...
⊕ **new Attachment**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Attachment](_classclients_.classclients.attachment.md)

⊕ **new Attachment**(client: *[Client](_client_.client.md)*): [Attachment](_classclients_.classclients.attachment.md)
...
*Defined in [ClassClients.ts:125](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L125)*
...
**Returns:** [Attachment](_classclients_.classclients.attachment.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:126](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L126)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Attachment`>
...
▸ **getCollection**(rallyObject: *`Attachment`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Attachment`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Attachment`>>
