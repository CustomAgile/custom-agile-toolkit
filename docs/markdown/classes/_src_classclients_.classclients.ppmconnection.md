[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [PPMConnection](../classes/_src_classclients_.classclients.ppmconnection.md)

# Class: PPMConnection

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`PPMConnection`>
...
* [constructor](_src_classclients_.classclients.ppmconnection.md#constructor)

### Properties

* [client](_src_classclients_.classclients.ppmconnection.md#client)
* [typeName](_src_classclients_.classclients.ppmconnection.md#typename)

### Methods

* [delete](_src_classclients_.classclients.ppmconnection.md#delete)
* [get](_src_classclients_.classclients.ppmconnection.md#get)
* [getCollection](_src_classclients_.classclients.ppmconnection.md#getcollection)
* [query](_src_classclients_.classclients.ppmconnection.md#query)
* [save](_src_classclients_.classclients.ppmconnection.md#save)
...
⊕ **new PPMConnection**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [PPMConnection](_src_classclients_.classclients.ppmconnection.md)

⊕ **new PPMConnection**(client: *[Client](_src_client_.client.md)*): [PPMConnection](_src_classclients_.classclients.ppmconnection.md)
...
*Defined in [src/ClassClients.ts:359](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L359)*
...
**Returns:** [PPMConnection](_src_classclients_.classclients.ppmconnection.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:360](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L360)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`PPMConnection`>
...
▸ **getCollection**(rallyObject: *`PPMConnection`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PPMConnection`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PPMConnection`>>
...
▸ **save**(rallyObject: *`Partial`<`PPMConnection`>*): `Promise`<`PPMConnection`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`PPMConnection`> |  A new or existing Rally object |
