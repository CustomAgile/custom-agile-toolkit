[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [AllowedAttributeValue](../classes/_classclients_.classclients.allowedattributevalue.md)

# Class: AllowedAttributeValue

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`AllowedAttributeValue`>
...
* [constructor](_classclients_.classclients.allowedattributevalue.md#constructor)

### Properties

* [client](_classclients_.classclients.allowedattributevalue.md#client)
* [typeName](_classclients_.classclients.allowedattributevalue.md#typename)

### Methods

* [delete](_classclients_.classclients.allowedattributevalue.md#delete)
* [get](_classclients_.classclients.allowedattributevalue.md#get)
* [getCollection](_classclients_.classclients.allowedattributevalue.md#getcollection)
* [query](_classclients_.classclients.allowedattributevalue.md#query)
* [save](_classclients_.classclients.allowedattributevalue.md#save)
...
⊕ **new AllowedAttributeValue**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [AllowedAttributeValue](_classclients_.classclients.allowedattributevalue.md)

⊕ **new AllowedAttributeValue**(client: *[Client](_client_.client.md)*): [AllowedAttributeValue](_classclients_.classclients.allowedattributevalue.md)
...
*Defined in [ClassClients.ts:80](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L80)*
...
**Returns:** [AllowedAttributeValue](_classclients_.classclients.allowedattributevalue.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:81](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L81)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`AllowedAttributeValue`>
...
▸ **getCollection**(rallyObject: *`AllowedAttributeValue`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`AllowedAttributeValue`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`AllowedAttributeValue`>>
