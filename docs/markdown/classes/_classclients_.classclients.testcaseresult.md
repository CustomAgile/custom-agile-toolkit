[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [TestCaseResult](../classes/_classclients_.classclients.testcaseresult.md)

# Class: TestCaseResult

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`TestCaseResult`>
...
* [constructor](_classclients_.classclients.testcaseresult.md#constructor)

### Properties

* [client](_classclients_.classclients.testcaseresult.md#client)
* [typeName](_classclients_.classclients.testcaseresult.md#typename)

### Methods

* [delete](_classclients_.classclients.testcaseresult.md#delete)
* [get](_classclients_.classclients.testcaseresult.md#get)
* [getCollection](_classclients_.classclients.testcaseresult.md#getcollection)
* [query](_classclients_.classclients.testcaseresult.md#query)
* [save](_classclients_.classclients.testcaseresult.md#save)
...
⊕ **new TestCaseResult**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [TestCaseResult](_classclients_.classclients.testcaseresult.md)

⊕ **new TestCaseResult**(client: *[Client](_client_.client.md)*): [TestCaseResult](_classclients_.classclients.testcaseresult.md)
...
*Defined in [ClassClients.ts:647](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L647)*
...
**Returns:** [TestCaseResult](_classclients_.classclients.testcaseresult.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:648](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L648)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`TestCaseResult`>
...
▸ **getCollection**(rallyObject: *`TestCaseResult`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TestCaseResult`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TestCaseResult`>>
