[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Requirement](../classes/_src_classclients_.classclients.requirement.md)

# Class: Requirement

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Requirement`>
...
* [constructor](_src_classclients_.classclients.requirement.md#constructor)

### Properties

* [client](_src_classclients_.classclients.requirement.md#client)
* [typeName](_src_classclients_.classclients.requirement.md#typename)

### Methods

* [delete](_src_classclients_.classclients.requirement.md#delete)
* [get](_src_classclients_.classclients.requirement.md#get)
* [getCollection](_src_classclients_.classclients.requirement.md#getcollection)
* [query](_src_classclients_.classclients.requirement.md#query)
* [save](_src_classclients_.classclients.requirement.md#save)
...
⊕ **new Requirement**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Requirement](_src_classclients_.classclients.requirement.md)

⊕ **new Requirement**(client: *[Client](_src_client_.client.md)*): [Requirement](_src_classclients_.classclients.requirement.md)
...
*Defined in [src/ClassClients.ts:503](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L503)*
...
**Returns:** [Requirement](_src_classclients_.classclients.requirement.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:504](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L504)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Requirement`>
...
▸ **getCollection**(rallyObject: *`Requirement`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Requirement`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Requirement`>>
