[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [FlowState](../classes/_src_classclients_.classclients.flowstate.md)

# Class: FlowState

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`FlowState`>
...
* [constructor](_src_classclients_.classclients.flowstate.md#constructor)

### Properties

* [client](_src_classclients_.classclients.flowstate.md#client)
* [typeName](_src_classclients_.classclients.flowstate.md#typename)

### Methods

* [delete](_src_classclients_.classclients.flowstate.md#delete)
* [get](_src_classclients_.classclients.flowstate.md#get)
* [getCollection](_src_classclients_.classclients.flowstate.md#getcollection)
* [query](_src_classclients_.classclients.flowstate.md#query)
* [save](_src_classclients_.classclients.flowstate.md#save)
...
⊕ **new FlowState**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [FlowState](_src_classclients_.classclients.flowstate.md)

⊕ **new FlowState**(client: *[Client](_src_client_.client.md)*): [FlowState](_src_classclients_.classclients.flowstate.md)
...
*Defined in [src/ClassClients.ts:287](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L287)*
...
**Returns:** [FlowState](_src_classclients_.classclients.flowstate.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:288](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L288)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`FlowState`>
...
▸ **getCollection**(rallyObject: *`FlowState`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`FlowState`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`FlowState`>>
