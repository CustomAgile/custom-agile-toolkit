[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [SubscriptionTag](../classes/_src_classclients_.classclients.subscriptiontag.md)

# Class: SubscriptionTag

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`SubscriptionTag`>
...
* [constructor](_src_classclients_.classclients.subscriptiontag.md#constructor)

### Properties

* [client](_src_classclients_.classclients.subscriptiontag.md#client)
* [typeName](_src_classclients_.classclients.subscriptiontag.md#typename)

### Methods

* [delete](_src_classclients_.classclients.subscriptiontag.md#delete)
* [get](_src_classclients_.classclients.subscriptiontag.md#get)
* [getCollection](_src_classclients_.classclients.subscriptiontag.md#getcollection)
* [query](_src_classclients_.classclients.subscriptiontag.md#query)
* [save](_src_classclients_.classclients.subscriptiontag.md#save)
...
⊕ **new SubscriptionTag**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [SubscriptionTag](_src_classclients_.classclients.subscriptiontag.md)

⊕ **new SubscriptionTag**(client: *[Client](_src_client_.client.md)*): [SubscriptionTag](_src_classclients_.classclients.subscriptiontag.md)
...
*Defined in [src/ClassClients.ts:611](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L611)*
...
**Returns:** [SubscriptionTag](_src_classclients_.classclients.subscriptiontag.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:612](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L612)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`SubscriptionTag`>
...
**Returns:** `Promise`<`SubscriptionTag`>
...
▸ **getCollection**(rallyObject: *`SubscriptionTag`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`SubscriptionTag`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`SubscriptionTag`>>
...
▸ **save**(rallyObject: *`Partial`<`SubscriptionTag`>*): `Promise`<`SubscriptionTag`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`SubscriptionTag`> |  A new or existing Rally object |
