[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [WorkspaceDomainObject](../classes/_src_classclients_.classclients.workspacedomainobject.md)

# Class: WorkspaceDomainObject

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`WorkspaceDomainObject`>
...
* [constructor](_src_classclients_.classclients.workspacedomainobject.md#constructor)

### Properties

* [client](_src_classclients_.classclients.workspacedomainobject.md#client)
* [typeName](_src_classclients_.classclients.workspacedomainobject.md#typename)

### Methods

* [delete](_src_classclients_.classclients.workspacedomainobject.md#delete)
* [get](_src_classclients_.classclients.workspacedomainobject.md#get)
* [getCollection](_src_classclients_.classclients.workspacedomainobject.md#getcollection)
* [query](_src_classclients_.classclients.workspacedomainobject.md#query)
* [save](_src_classclients_.classclients.workspacedomainobject.md#save)
...
⊕ **new WorkspaceDomainObject**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [WorkspaceDomainObject](_src_classclients_.classclients.workspacedomainobject.md)

⊕ **new WorkspaceDomainObject**(client: *[Client](_src_client_.client.md)*): [WorkspaceDomainObject](_src_classclients_.classclients.workspacedomainobject.md)
...
*Defined in [src/ClassClients.ts:791](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L791)*
...
**Returns:** [WorkspaceDomainObject](_src_classclients_.classclients.workspacedomainobject.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:792](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L792)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`WorkspaceDomainObject`>
...
▸ **getCollection**(rallyObject: *`WorkspaceDomainObject`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`WorkspaceDomainObject`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`WorkspaceDomainObject`>>
