[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [WorkspacePermission](../classes/_src_classclients_.classclients.workspacepermission.md)

# Class: WorkspacePermission

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`WorkspacePermission`>
...
* [constructor](_src_classclients_.classclients.workspacepermission.md#constructor)

### Properties

* [client](_src_classclients_.classclients.workspacepermission.md#client)
* [typeName](_src_classclients_.classclients.workspacepermission.md#typename)

### Methods

* [delete](_src_classclients_.classclients.workspacepermission.md#delete)
* [get](_src_classclients_.classclients.workspacepermission.md#get)
* [getCollection](_src_classclients_.classclients.workspacepermission.md#getcollection)
* [query](_src_classclients_.classclients.workspacepermission.md#query)
* [save](_src_classclients_.classclients.workspacepermission.md#save)
...
⊕ **new WorkspacePermission**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [WorkspacePermission](_src_classclients_.classclients.workspacepermission.md)

⊕ **new WorkspacePermission**(client: *[Client](_src_client_.client.md)*): [WorkspacePermission](_src_classclients_.classclients.workspacepermission.md)
...
*Defined in [src/ClassClients.ts:800](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L800)*
...
**Returns:** [WorkspacePermission](_src_classclients_.classclients.workspacepermission.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:801](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L801)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`WorkspacePermission`>
...
▸ **getCollection**(rallyObject: *`WorkspacePermission`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`WorkspacePermission`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`WorkspacePermission`>>
