[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [PortfolioItem](../classes/_src_classclients_.classclients.portfolioitem.md)

# Class: PortfolioItem

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`PortfolioItem`>
...
* [constructor](_src_classclients_.classclients.portfolioitem.md#constructor)

### Properties

* [client](_src_classclients_.classclients.portfolioitem.md#client)
* [typeName](_src_classclients_.classclients.portfolioitem.md#typename)

### Methods

* [delete](_src_classclients_.classclients.portfolioitem.md#delete)
* [get](_src_classclients_.classclients.portfolioitem.md#get)
* [getCollection](_src_classclients_.classclients.portfolioitem.md#getcollection)
* [query](_src_classclients_.classclients.portfolioitem.md#query)
* [save](_src_classclients_.classclients.portfolioitem.md#save)
...
⊕ **new PortfolioItem**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [PortfolioItem](_src_classclients_.classclients.portfolioitem.md)

⊕ **new PortfolioItem**(client: *[Client](_src_client_.client.md)*): [PortfolioItem](_src_classclients_.classclients.portfolioitem.md)
...
*Defined in [src/ClassClients.ts:395](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L395)*
...
**Returns:** [PortfolioItem](_src_classclients_.classclients.portfolioitem.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:396](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L396)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`PortfolioItem`>
...
▸ **getCollection**(rallyObject: *`PortfolioItem`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PortfolioItem`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PortfolioItem`>>
...
▸ **save**(rallyObject: *`Partial`<`PortfolioItem`>*): `Promise`<`PortfolioItem`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`PortfolioItem`> |  A new or existing Rally object |
