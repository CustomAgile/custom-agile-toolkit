[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [ScopedAttributeDefinition](../classes/_src_classclients_.classclients.scopedattributedefinition.md)

# Class: ScopedAttributeDefinition

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`ScopedAttributeDefinition`>
...
* [constructor](_src_classclients_.classclients.scopedattributedefinition.md#constructor)

### Properties

* [client](_src_classclients_.classclients.scopedattributedefinition.md#client)
* [typeName](_src_classclients_.classclients.scopedattributedefinition.md#typename)

### Methods

* [delete](_src_classclients_.classclients.scopedattributedefinition.md#delete)
* [get](_src_classclients_.classclients.scopedattributedefinition.md#get)
* [getCollection](_src_classclients_.classclients.scopedattributedefinition.md#getcollection)
* [query](_src_classclients_.classclients.scopedattributedefinition.md#query)
* [save](_src_classclients_.classclients.scopedattributedefinition.md#save)
...
⊕ **new ScopedAttributeDefinition**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [ScopedAttributeDefinition](_src_classclients_.classclients.scopedattributedefinition.md)

⊕ **new ScopedAttributeDefinition**(client: *[Client](_src_client_.client.md)*): [ScopedAttributeDefinition](_src_classclients_.classclients.scopedattributedefinition.md)
...
*Defined in [src/ClassClients.ts:575](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L575)*
...
**Returns:** [ScopedAttributeDefinition](_src_classclients_.classclients.scopedattributedefinition.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:576](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L576)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`ScopedAttributeDefinition`>
...
**Returns:** `Promise`<`ScopedAttributeDefinition`>
...
▸ **getCollection**(rallyObject: *`ScopedAttributeDefinition`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
| Name | Type | Default value |
| ------ | ------ | ------ |
| rallyObject | `ScopedAttributeDefinition` | - |
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`ScopedAttributeDefinition`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`ScopedAttributeDefinition`>>
...
▸ **save**(rallyObject: *`Partial`<`ScopedAttributeDefinition`>*): `Promise`<`ScopedAttributeDefinition`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`ScopedAttributeDefinition`> |  A new or existing Rally object |
