[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Initiative](../classes/_classclients_.classclients.initiative.md)

# Class: Initiative

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Initiative`>
...
* [constructor](_classclients_.classclients.initiative.md#constructor)

### Properties

* [client](_classclients_.classclients.initiative.md#client)
* [typeName](_classclients_.classclients.initiative.md#typename)

### Methods

* [delete](_classclients_.classclients.initiative.md#delete)
* [get](_classclients_.classclients.initiative.md#get)
* [getCollection](_classclients_.classclients.initiative.md#getcollection)
* [query](_classclients_.classclients.initiative.md#query)
* [save](_classclients_.classclients.initiative.md#save)
...
⊕ **new Initiative**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Initiative](_classclients_.classclients.initiative.md)

⊕ **new Initiative**(client: *[Client](_client_.client.md)*): [Initiative](_classclients_.classclients.initiative.md)
...
*Defined in [ClassClients.ts:314](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L314)*
...
**Returns:** [Initiative](_classclients_.classclients.initiative.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:315](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L315)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Initiative`>
...
▸ **getCollection**(rallyObject: *`Initiative`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Initiative`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Initiative`>>
