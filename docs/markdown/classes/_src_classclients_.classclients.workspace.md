[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Workspace](../classes/_src_classclients_.classclients.workspace.md)

# Class: Workspace

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Workspace`>
...
* [constructor](_src_classclients_.classclients.workspace.md#constructor)

### Properties

* [client](_src_classclients_.classclients.workspace.md#client)
* [typeName](_src_classclients_.classclients.workspace.md#typename)

### Methods

* [delete](_src_classclients_.classclients.workspace.md#delete)
* [get](_src_classclients_.classclients.workspace.md#get)
* [getCollection](_src_classclients_.classclients.workspace.md#getcollection)
* [query](_src_classclients_.classclients.workspace.md#query)
* [save](_src_classclients_.classclients.workspace.md#save)
...
⊕ **new Workspace**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Workspace](_src_classclients_.classclients.workspace.md)

⊕ **new Workspace**(client: *[Client](_src_client_.client.md)*): [Workspace](_src_classclients_.classclients.workspace.md)
...
*Defined in [src/ClassClients.ts:773](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L773)*
...
**Returns:** [Workspace](_src_classclients_.classclients.workspace.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:774](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L774)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Workspace`>
...
▸ **getCollection**(rallyObject: *`Workspace`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Workspace`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Workspace`>>
