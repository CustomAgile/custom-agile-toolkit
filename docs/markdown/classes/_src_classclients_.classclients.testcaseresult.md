[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [TestCaseResult](../classes/_src_classclients_.classclients.testcaseresult.md)

# Class: TestCaseResult

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`TestCaseResult`>
...
* [constructor](_src_classclients_.classclients.testcaseresult.md#constructor)

### Properties

* [client](_src_classclients_.classclients.testcaseresult.md#client)
* [typeName](_src_classclients_.classclients.testcaseresult.md#typename)

### Methods

* [delete](_src_classclients_.classclients.testcaseresult.md#delete)
* [get](_src_classclients_.classclients.testcaseresult.md#get)
* [getCollection](_src_classclients_.classclients.testcaseresult.md#getcollection)
* [query](_src_classclients_.classclients.testcaseresult.md#query)
* [save](_src_classclients_.classclients.testcaseresult.md#save)
...
⊕ **new TestCaseResult**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [TestCaseResult](_src_classclients_.classclients.testcaseresult.md)

⊕ **new TestCaseResult**(client: *[Client](_src_client_.client.md)*): [TestCaseResult](_src_classclients_.classclients.testcaseresult.md)
...
*Defined in [src/ClassClients.ts:647](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L647)*
...
**Returns:** [TestCaseResult](_src_classclients_.classclients.testcaseresult.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:648](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L648)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`TestCaseResult`>
...
▸ **getCollection**(rallyObject: *`TestCaseResult`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TestCaseResult`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TestCaseResult`>>
...
▸ **save**(rallyObject: *`Partial`<`TestCaseResult`>*): `Promise`<`TestCaseResult`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`TestCaseResult`> |  A new or existing Rally object |
