[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [WorkspaceConfiguration](../classes/_src_classclients_.classclients.workspaceconfiguration.md)

# Class: WorkspaceConfiguration

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`WorkspaceConfiguration`>
...
* [constructor](_src_classclients_.classclients.workspaceconfiguration.md#constructor)

### Properties

* [client](_src_classclients_.classclients.workspaceconfiguration.md#client)
* [typeName](_src_classclients_.classclients.workspaceconfiguration.md#typename)

### Methods

* [delete](_src_classclients_.classclients.workspaceconfiguration.md#delete)
* [get](_src_classclients_.classclients.workspaceconfiguration.md#get)
* [getCollection](_src_classclients_.classclients.workspaceconfiguration.md#getcollection)
* [query](_src_classclients_.classclients.workspaceconfiguration.md#query)
* [save](_src_classclients_.classclients.workspaceconfiguration.md#save)
...
⊕ **new WorkspaceConfiguration**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [WorkspaceConfiguration](_src_classclients_.classclients.workspaceconfiguration.md)

⊕ **new WorkspaceConfiguration**(client: *[Client](_src_client_.client.md)*): [WorkspaceConfiguration](_src_classclients_.classclients.workspaceconfiguration.md)
...
*Defined in [src/ClassClients.ts:782](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L782)*
...
**Returns:** [WorkspaceConfiguration](_src_classclients_.classclients.workspaceconfiguration.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:783](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L783)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`WorkspaceConfiguration`>
...
▸ **getCollection**(rallyObject: *`WorkspaceConfiguration`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`WorkspaceConfiguration`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`WorkspaceConfiguration`>>
