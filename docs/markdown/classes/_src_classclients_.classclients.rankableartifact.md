[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [RankableArtifact](../classes/_src_classclients_.classclients.rankableartifact.md)

# Class: RankableArtifact

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`RankableArtifact`>
...
* [constructor](_src_classclients_.classclients.rankableartifact.md#constructor)

### Properties

* [client](_src_classclients_.classclients.rankableartifact.md#client)
* [typeName](_src_classclients_.classclients.rankableartifact.md#typename)

### Methods

* [delete](_src_classclients_.classclients.rankableartifact.md#delete)
* [get](_src_classclients_.classclients.rankableartifact.md#get)
* [getCollection](_src_classclients_.classclients.rankableartifact.md#getcollection)
* [query](_src_classclients_.classclients.rankableartifact.md#query)
* [save](_src_classclients_.classclients.rankableartifact.md#save)
...
⊕ **new RankableArtifact**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [RankableArtifact](_src_classclients_.classclients.rankableartifact.md)

⊕ **new RankableArtifact**(client: *[Client](_src_client_.client.md)*): [RankableArtifact](_src_classclients_.classclients.rankableartifact.md)
...
*Defined in [src/ClassClients.ts:467](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L467)*
...
**Returns:** [RankableArtifact](_src_classclients_.classclients.rankableartifact.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:468](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L468)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`RankableArtifact`>
...
▸ **getCollection**(rallyObject: *`RankableArtifact`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`RankableArtifact`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`RankableArtifact`>>
