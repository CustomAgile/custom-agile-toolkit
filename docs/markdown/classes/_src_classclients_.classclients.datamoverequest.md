[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [DataMoveRequest](../classes/_src_classclients_.classclients.datamoverequest.md)

# Class: DataMoveRequest

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`DataMoveRequest`>
...
* [constructor](_src_classclients_.classclients.datamoverequest.md#constructor)

### Properties

* [client](_src_classclients_.classclients.datamoverequest.md#client)
* [typeName](_src_classclients_.classclients.datamoverequest.md#typename)

### Methods

* [delete](_src_classclients_.classclients.datamoverequest.md#delete)
* [get](_src_classclients_.classclients.datamoverequest.md#get)
* [getCollection](_src_classclients_.classclients.datamoverequest.md#getcollection)
* [query](_src_classclients_.classclients.datamoverequest.md#query)
* [save](_src_classclients_.classclients.datamoverequest.md#save)
...
⊕ **new DataMoveRequest**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [DataMoveRequest](_src_classclients_.classclients.datamoverequest.md)

⊕ **new DataMoveRequest**(client: *[Client](_src_client_.client.md)*): [DataMoveRequest](_src_classclients_.classclients.datamoverequest.md)
...
*Defined in [src/ClassClients.ts:233](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L233)*
...
**Returns:** [DataMoveRequest](_src_classclients_.classclients.datamoverequest.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:234](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L234)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`DataMoveRequest`>
...
**Returns:** `Promise`<`DataMoveRequest`>
...
▸ **getCollection**(rallyObject: *`DataMoveRequest`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`DataMoveRequest`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`DataMoveRequest`>>
...
▸ **save**(rallyObject: *`Partial`<`DataMoveRequest`>*): `Promise`<`DataMoveRequest`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`DataMoveRequest`> |  A new or existing Rally object |
