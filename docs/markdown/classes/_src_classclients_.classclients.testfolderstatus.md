[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [TestFolderStatus](../classes/_src_classclients_.classclients.testfolderstatus.md)

# Class: TestFolderStatus

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`TestFolderStatus`>
...
* [constructor](_src_classclients_.classclients.testfolderstatus.md#constructor)

### Properties

* [client](_src_classclients_.classclients.testfolderstatus.md#client)
* [typeName](_src_classclients_.classclients.testfolderstatus.md#typename)

### Methods

* [delete](_src_classclients_.classclients.testfolderstatus.md#delete)
* [get](_src_classclients_.classclients.testfolderstatus.md#get)
* [getCollection](_src_classclients_.classclients.testfolderstatus.md#getcollection)
* [query](_src_classclients_.classclients.testfolderstatus.md#query)
* [save](_src_classclients_.classclients.testfolderstatus.md#save)
...
⊕ **new TestFolderStatus**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [TestFolderStatus](_src_classclients_.classclients.testfolderstatus.md)

⊕ **new TestFolderStatus**(client: *[Client](_src_client_.client.md)*): [TestFolderStatus](_src_classclients_.classclients.testfolderstatus.md)
...
*Defined in [src/ClassClients.ts:674](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L674)*
...
**Returns:** [TestFolderStatus](_src_classclients_.classclients.testfolderstatus.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:675](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L675)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`TestFolderStatus`>
...
**Returns:** `Promise`<`TestFolderStatus`>
...
▸ **getCollection**(rallyObject: *`TestFolderStatus`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TestFolderStatus`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`TestFolderStatus`>>
...
▸ **save**(rallyObject: *`Partial`<`TestFolderStatus`>*): `Promise`<`TestFolderStatus`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`TestFolderStatus`> |  A new or existing Rally object |
