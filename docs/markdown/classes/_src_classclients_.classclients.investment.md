[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Investment](../classes/_src_classclients_.classclients.investment.md)

# Class: Investment

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Investment`>
...
* [constructor](_src_classclients_.classclients.investment.md#constructor)

### Properties

* [client](_src_classclients_.classclients.investment.md#client)
* [typeName](_src_classclients_.classclients.investment.md#typename)

### Methods

* [delete](_src_classclients_.classclients.investment.md#delete)
* [get](_src_classclients_.classclients.investment.md#get)
* [getCollection](_src_classclients_.classclients.investment.md#getcollection)
* [query](_src_classclients_.classclients.investment.md#query)
* [save](_src_classclients_.classclients.investment.md#save)
...
⊕ **new Investment**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Investment](_src_classclients_.classclients.investment.md)

⊕ **new Investment**(client: *[Client](_src_client_.client.md)*): [Investment](_src_classclients_.classclients.investment.md)
...
*Defined in [src/ClassClients.ts:323](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L323)*
...
**Returns:** [Investment](_src_classclients_.classclients.investment.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:324](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L324)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Investment`>
...
▸ **getCollection**(rallyObject: *`Investment`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Investment`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Investment`>>
