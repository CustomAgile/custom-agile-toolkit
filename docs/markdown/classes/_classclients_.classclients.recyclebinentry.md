[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [RecycleBinEntry](../classes/_classclients_.classclients.recyclebinentry.md)

# Class: RecycleBinEntry

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`RecycleBinEntry`>
...
* [constructor](_classclients_.classclients.recyclebinentry.md#constructor)

### Properties

* [client](_classclients_.classclients.recyclebinentry.md#client)
* [typeName](_classclients_.classclients.recyclebinentry.md#typename)

### Methods

* [delete](_classclients_.classclients.recyclebinentry.md#delete)
* [get](_classclients_.classclients.recyclebinentry.md#get)
* [getCollection](_classclients_.classclients.recyclebinentry.md#getcollection)
* [query](_classclients_.classclients.recyclebinentry.md#query)
* [save](_classclients_.classclients.recyclebinentry.md#save)
...
⊕ **new RecycleBinEntry**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [RecycleBinEntry](_classclients_.classclients.recyclebinentry.md)

⊕ **new RecycleBinEntry**(client: *[Client](_client_.client.md)*): [RecycleBinEntry](_classclients_.classclients.recyclebinentry.md)
...
*Defined in [ClassClients.ts:476](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L476)*
...
**Returns:** [RecycleBinEntry](_classclients_.classclients.recyclebinentry.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:477](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L477)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`RecycleBinEntry`>
...
▸ **getCollection**(rallyObject: *`RecycleBinEntry`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`RecycleBinEntry`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`RecycleBinEntry`>>
