[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [FeatureToggleEntity](../classes/_src_classclients_.classclients.featuretoggleentity.md)

# Class: FeatureToggleEntity

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`FeatureToggleEntity`>
...
* [constructor](_src_classclients_.classclients.featuretoggleentity.md#constructor)

### Properties

* [client](_src_classclients_.classclients.featuretoggleentity.md#client)
* [typeName](_src_classclients_.classclients.featuretoggleentity.md#typename)

### Methods

* [delete](_src_classclients_.classclients.featuretoggleentity.md#delete)
* [get](_src_classclients_.classclients.featuretoggleentity.md#get)
* [getCollection](_src_classclients_.classclients.featuretoggleentity.md#getcollection)
* [query](_src_classclients_.classclients.featuretoggleentity.md#query)
* [save](_src_classclients_.classclients.featuretoggleentity.md#save)
...
⊕ **new FeatureToggleEntity**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [FeatureToggleEntity](_src_classclients_.classclients.featuretoggleentity.md)

⊕ **new FeatureToggleEntity**(client: *[Client](_src_client_.client.md)*): [FeatureToggleEntity](_src_classclients_.classclients.featuretoggleentity.md)
...
*Defined in [src/ClassClients.ts:278](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L278)*
...
**Returns:** [FeatureToggleEntity](_src_classclients_.classclients.featuretoggleentity.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:279](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L279)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`FeatureToggleEntity`>
...
▸ **getCollection**(rallyObject: *`FeatureToggleEntity`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`FeatureToggleEntity`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`FeatureToggleEntity`>>
