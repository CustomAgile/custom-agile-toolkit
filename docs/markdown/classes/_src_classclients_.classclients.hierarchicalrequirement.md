[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [HierarchicalRequirement](../classes/_src_classclients_.classclients.hierarchicalrequirement.md)

# Class: HierarchicalRequirement

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`HierarchicalRequirement`>
...
* [constructor](_src_classclients_.classclients.hierarchicalrequirement.md#constructor)

### Properties

* [client](_src_classclients_.classclients.hierarchicalrequirement.md#client)
* [typeName](_src_classclients_.classclients.hierarchicalrequirement.md#typename)

### Methods

* [delete](_src_classclients_.classclients.hierarchicalrequirement.md#delete)
* [get](_src_classclients_.classclients.hierarchicalrequirement.md#get)
* [getCollection](_src_classclients_.classclients.hierarchicalrequirement.md#getcollection)
* [query](_src_classclients_.classclients.hierarchicalrequirement.md#query)
* [save](_src_classclients_.classclients.hierarchicalrequirement.md#save)
...
⊕ **new HierarchicalRequirement**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [HierarchicalRequirement](_src_classclients_.classclients.hierarchicalrequirement.md)

⊕ **new HierarchicalRequirement**(client: *[Client](_src_client_.client.md)*): [HierarchicalRequirement](_src_classclients_.classclients.hierarchicalrequirement.md)
...
*Defined in [src/ClassClients.ts:296](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L296)*
...
**Returns:** [HierarchicalRequirement](_src_classclients_.classclients.hierarchicalrequirement.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:297](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L297)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`HierarchicalRequirement`>
...
**Returns:** `Promise`<`HierarchicalRequirement`>
...
▸ **getCollection**(rallyObject: *`HierarchicalRequirement`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
| Name | Type | Default value |
| ------ | ------ | ------ |
| rallyObject | `HierarchicalRequirement` | - |
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`HierarchicalRequirement`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`HierarchicalRequirement`>>
...
▸ **save**(rallyObject: *`Partial`<`HierarchicalRequirement`>*): `Promise`<`HierarchicalRequirement`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`HierarchicalRequirement`> |  A new or existing Rally object |
