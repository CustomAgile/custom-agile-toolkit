[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [ArtifactNotification](../classes/_src_classclients_.classclients.artifactnotification.md)

# Class: ArtifactNotification

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`ArtifactNotification`>
...
* [constructor](_src_classclients_.classclients.artifactnotification.md#constructor)

### Properties

* [client](_src_classclients_.classclients.artifactnotification.md#client)
* [typeName](_src_classclients_.classclients.artifactnotification.md#typename)

### Methods

* [delete](_src_classclients_.classclients.artifactnotification.md#delete)
* [get](_src_classclients_.classclients.artifactnotification.md#get)
* [getCollection](_src_classclients_.classclients.artifactnotification.md#getcollection)
* [query](_src_classclients_.classclients.artifactnotification.md#query)
* [save](_src_classclients_.classclients.artifactnotification.md#save)
...
⊕ **new ArtifactNotification**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [ArtifactNotification](_src_classclients_.classclients.artifactnotification.md)

⊕ **new ArtifactNotification**(client: *[Client](_src_client_.client.md)*): [ArtifactNotification](_src_classclients_.classclients.artifactnotification.md)
...
*Defined in [src/ClassClients.ts:116](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L116)*
...
**Returns:** [ArtifactNotification](_src_classclients_.classclients.artifactnotification.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:117](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L117)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`ArtifactNotification`>
...
▸ **getCollection**(rallyObject: *`ArtifactNotification`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`ArtifactNotification`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`ArtifactNotification`>>
