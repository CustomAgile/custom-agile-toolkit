[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Project](../classes/_src_classclients_.classclients.project.md)

# Class: Project

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Project`>
...
* [constructor](_src_classclients_.classclients.project.md#constructor)

### Properties

* [client](_src_classclients_.classclients.project.md#client)
* [typeName](_src_classclients_.classclients.project.md#typename)

### Methods

* [delete](_src_classclients_.classclients.project.md#delete)
* [get](_src_classclients_.classclients.project.md#get)
* [getCollection](_src_classclients_.classclients.project.md#getcollection)
* [query](_src_classclients_.classclients.project.md#query)
* [save](_src_classclients_.classclients.project.md#save)
...
⊕ **new Project**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Project](_src_classclients_.classclients.project.md)

⊕ **new Project**(client: *[Client](_src_client_.client.md)*): [Project](_src_classclients_.classclients.project.md)
...
*Defined in [src/ClassClients.ts:440](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L440)*
...
**Returns:** [Project](_src_classclients_.classclients.project.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:441](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L441)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Project`>
...
▸ **getCollection**(rallyObject: *`Project`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Project`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Project`>>
