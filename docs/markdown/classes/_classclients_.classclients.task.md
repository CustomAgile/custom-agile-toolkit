[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Task](../classes/_classclients_.classclients.task.md)

# Class: Task

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Task`>
...
* [constructor](_classclients_.classclients.task.md#constructor)

### Properties

* [client](_classclients_.classclients.task.md#client)
* [typeName](_classclients_.classclients.task.md#typename)

### Methods

* [delete](_classclients_.classclients.task.md#delete)
* [get](_classclients_.classclients.task.md#get)
* [getCollection](_classclients_.classclients.task.md#getcollection)
* [query](_classclients_.classclients.task.md#query)
* [save](_classclients_.classclients.task.md#save)
...
⊕ **new Task**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Task](_classclients_.classclients.task.md)

⊕ **new Task**(client: *[Client](_client_.client.md)*): [Task](_classclients_.classclients.task.md)
...
*Defined in [ClassClients.ts:629](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L629)*
...
**Returns:** [Task](_classclients_.classclients.task.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:630](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L630)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Task`>
...
▸ **getCollection**(rallyObject: *`Task`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Task`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Task`>>
