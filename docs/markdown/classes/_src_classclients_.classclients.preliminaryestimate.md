[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [PreliminaryEstimate](../classes/_src_classclients_.classclients.preliminaryestimate.md)

# Class: PreliminaryEstimate

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`PreliminaryEstimate`>
...
* [constructor](_src_classclients_.classclients.preliminaryestimate.md#constructor)

### Properties

* [client](_src_classclients_.classclients.preliminaryestimate.md#client)
* [typeName](_src_classclients_.classclients.preliminaryestimate.md#typename)

### Methods

* [delete](_src_classclients_.classclients.preliminaryestimate.md#delete)
* [get](_src_classclients_.classclients.preliminaryestimate.md#get)
* [getCollection](_src_classclients_.classclients.preliminaryestimate.md#getcollection)
* [query](_src_classclients_.classclients.preliminaryestimate.md#query)
* [save](_src_classclients_.classclients.preliminaryestimate.md#save)
...
⊕ **new PreliminaryEstimate**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [PreliminaryEstimate](_src_classclients_.classclients.preliminaryestimate.md)

⊕ **new PreliminaryEstimate**(client: *[Client](_src_client_.client.md)*): [PreliminaryEstimate](_src_classclients_.classclients.preliminaryestimate.md)
...
*Defined in [src/ClassClients.ts:422](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L422)*
...
**Returns:** [PreliminaryEstimate](_src_classclients_.classclients.preliminaryestimate.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:423](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L423)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`PreliminaryEstimate`>
...
▸ **getCollection**(rallyObject: *`PreliminaryEstimate`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PreliminaryEstimate`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PreliminaryEstimate`>>
