[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [AllowedAttributeValue](../classes/_src_classclients_.classclients.allowedattributevalue.md)

# Class: AllowedAttributeValue

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`AllowedAttributeValue`>
...
* [constructor](_src_classclients_.classclients.allowedattributevalue.md#constructor)

### Properties

* [client](_src_classclients_.classclients.allowedattributevalue.md#client)
* [typeName](_src_classclients_.classclients.allowedattributevalue.md#typename)

### Methods

* [delete](_src_classclients_.classclients.allowedattributevalue.md#delete)
* [get](_src_classclients_.classclients.allowedattributevalue.md#get)
* [getCollection](_src_classclients_.classclients.allowedattributevalue.md#getcollection)
* [query](_src_classclients_.classclients.allowedattributevalue.md#query)
* [save](_src_classclients_.classclients.allowedattributevalue.md#save)
...
⊕ **new AllowedAttributeValue**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [AllowedAttributeValue](_src_classclients_.classclients.allowedattributevalue.md)

⊕ **new AllowedAttributeValue**(client: *[Client](_src_client_.client.md)*): [AllowedAttributeValue](_src_classclients_.classclients.allowedattributevalue.md)
...
*Defined in [src/ClassClients.ts:80](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L80)*
...
**Returns:** [AllowedAttributeValue](_src_classclients_.classclients.allowedattributevalue.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:81](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L81)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`AllowedAttributeValue`>
...
**Returns:** `Promise`<`AllowedAttributeValue`>
...
▸ **getCollection**(rallyObject: *`AllowedAttributeValue`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
| Name | Type | Default value |
| ------ | ------ | ------ |
| rallyObject | `AllowedAttributeValue` | - |
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`AllowedAttributeValue`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`AllowedAttributeValue`>>
...
▸ **save**(rallyObject: *`Partial`<`AllowedAttributeValue`>*): `Promise`<`AllowedAttributeValue`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`AllowedAttributeValue`> |  A new or existing Rally object |
