[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [WebLinkDefinition](../classes/_classclients_.classclients.weblinkdefinition.md)

# Class: WebLinkDefinition

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`WebLinkDefinition`>
...
* [constructor](_classclients_.classclients.weblinkdefinition.md#constructor)

### Properties

* [client](_classclients_.classclients.weblinkdefinition.md#client)
* [typeName](_classclients_.classclients.weblinkdefinition.md#typename)

### Methods

* [delete](_classclients_.classclients.weblinkdefinition.md#delete)
* [get](_classclients_.classclients.weblinkdefinition.md#get)
* [getCollection](_classclients_.classclients.weblinkdefinition.md#getcollection)
* [query](_classclients_.classclients.weblinkdefinition.md#query)
* [save](_classclients_.classclients.weblinkdefinition.md#save)
...
⊕ **new WebLinkDefinition**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [WebLinkDefinition](_classclients_.classclients.weblinkdefinition.md)

⊕ **new WebLinkDefinition**(client: *[Client](_client_.client.md)*): [WebLinkDefinition](_classclients_.classclients.weblinkdefinition.md)
...
*Defined in [ClassClients.ts:755](https://github.com/ferentchak/rally-node-sdk/blob/45aae0f/ClassClients.ts#L755)*
...
**Returns:** [WebLinkDefinition](_classclients_.classclients.weblinkdefinition.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:756](https://github.com/ferentchak/rally-node-sdk/blob/45aae0f/ClassClients.ts#L756)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`WebLinkDefinition`>
...
▸ **getCollection**(rallyObject: *`WebLinkDefinition`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`WebLinkDefinition`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`WebLinkDefinition`>>
