[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [ScheduledTestCase](../classes/_src_classclients_.classclients.scheduledtestcase.md)

# Class: ScheduledTestCase

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`ScheduledTestCase`>
...
* [constructor](_src_classclients_.classclients.scheduledtestcase.md#constructor)

### Properties

* [client](_src_classclients_.classclients.scheduledtestcase.md#client)
* [typeName](_src_classclients_.classclients.scheduledtestcase.md#typename)

### Methods

* [delete](_src_classclients_.classclients.scheduledtestcase.md#delete)
* [get](_src_classclients_.classclients.scheduledtestcase.md#get)
* [getCollection](_src_classclients_.classclients.scheduledtestcase.md#getcollection)
* [query](_src_classclients_.classclients.scheduledtestcase.md#query)
* [save](_src_classclients_.classclients.scheduledtestcase.md#save)
...
⊕ **new ScheduledTestCase**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [ScheduledTestCase](_src_classclients_.classclients.scheduledtestcase.md)

⊕ **new ScheduledTestCase**(client: *[Client](_src_client_.client.md)*): [ScheduledTestCase](_src_classclients_.classclients.scheduledtestcase.md)
...
*Defined in [src/ClassClients.ts:557](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L557)*
...
**Returns:** [ScheduledTestCase](_src_classclients_.classclients.scheduledtestcase.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:558](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L558)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`ScheduledTestCase`>
...
▸ **getCollection**(rallyObject: *`ScheduledTestCase`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`ScheduledTestCase`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`ScheduledTestCase`>>
