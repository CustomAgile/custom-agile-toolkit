[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [DefectSuite](../classes/_src_classclients_.classclients.defectsuite.md)

# Class: DefectSuite

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`DefectSuite`>
...
* [constructor](_src_classclients_.classclients.defectsuite.md#constructor)

### Properties

* [client](_src_classclients_.classclients.defectsuite.md#client)
* [typeName](_src_classclients_.classclients.defectsuite.md#typename)

### Methods

* [delete](_src_classclients_.classclients.defectsuite.md#delete)
* [get](_src_classclients_.classclients.defectsuite.md#get)
* [getCollection](_src_classclients_.classclients.defectsuite.md#getcollection)
* [query](_src_classclients_.classclients.defectsuite.md#query)
* [save](_src_classclients_.classclients.defectsuite.md#save)
...
⊕ **new DefectSuite**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [DefectSuite](_src_classclients_.classclients.defectsuite.md)

⊕ **new DefectSuite**(client: *[Client](_src_client_.client.md)*): [DefectSuite](_src_classclients_.classclients.defectsuite.md)
...
*Defined in [src/ClassClients.ts:251](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L251)*
...
**Returns:** [DefectSuite](_src_classclients_.classclients.defectsuite.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:252](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L252)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`DefectSuite`>
...
▸ **getCollection**(rallyObject: *`DefectSuite`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`DefectSuite`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`DefectSuite`>>
