[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [Release](../classes/_classclients_.classclients.release.md)

# Class: Release

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`Release`>
...
* [constructor](_classclients_.classclients.release.md#constructor)

### Properties

* [client](_classclients_.classclients.release.md#client)
* [typeName](_classclients_.classclients.release.md#typename)

### Methods

* [delete](_classclients_.classclients.release.md#delete)
* [get](_classclients_.classclients.release.md#get)
* [getCollection](_classclients_.classclients.release.md#getcollection)
* [query](_classclients_.classclients.release.md#query)
* [save](_classclients_.classclients.release.md#save)
...
⊕ **new Release**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [Release](_classclients_.classclients.release.md)

⊕ **new Release**(client: *[Client](_client_.client.md)*): [Release](_classclients_.classclients.release.md)
...
*Defined in [ClassClients.ts:485](https://github.com/ferentchak/rally-node-sdk/blob/88a0ac6/ClassClients.ts#L485)*
...
**Returns:** [Release](_classclients_.classclients.release.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:486](https://github.com/ferentchak/rally-node-sdk/blob/88a0ac6/ClassClients.ts#L486)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`Release`>
...
▸ **getCollection**(rallyObject: *`Release`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Release`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`Release`>>
