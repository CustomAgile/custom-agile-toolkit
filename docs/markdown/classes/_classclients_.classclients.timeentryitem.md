[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [TimeEntryItem](../classes/_classclients_.classclients.timeentryitem.md)

# Class: TimeEntryItem

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`TimeEntryItem`>
...
* [constructor](_classclients_.classclients.timeentryitem.md#constructor)

### Properties

* [client](_classclients_.classclients.timeentryitem.md#client)
* [typeName](_classclients_.classclients.timeentryitem.md#typename)

### Methods

* [delete](_classclients_.classclients.timeentryitem.md#delete)
* [get](_classclients_.classclients.timeentryitem.md#get)
* [getCollection](_classclients_.classclients.timeentryitem.md#getcollection)
* [query](_classclients_.classclients.timeentryitem.md#query)
* [save](_classclients_.classclients.timeentryitem.md#save)
...
⊕ **new TimeEntryItem**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [TimeEntryItem](_classclients_.classclients.timeentryitem.md)

⊕ **new TimeEntryItem**(client: *[Client](_client_.client.md)*): [TimeEntryItem](_classclients_.classclients.timeentryitem.md)
...
*Defined in [ClassClients.ts:692](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L692)*
...
**Returns:** [TimeEntryItem](_classclients_.classclients.timeentryitem.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:693](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L693)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`TimeEntryItem`>
...
▸ **getCollection**(rallyObject: *`TimeEntryItem`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TimeEntryItem`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TimeEntryItem`>>
