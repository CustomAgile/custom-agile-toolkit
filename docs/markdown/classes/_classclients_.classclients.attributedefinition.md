[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [AttributeDefinition](../classes/_classclients_.classclients.attributedefinition.md)

# Class: AttributeDefinition

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`AttributeDefinition`>
...
* [constructor](_classclients_.classclients.attributedefinition.md#constructor)

### Properties

* [client](_classclients_.classclients.attributedefinition.md#client)
* [typeName](_classclients_.classclients.attributedefinition.md#typename)

### Methods

* [delete](_classclients_.classclients.attributedefinition.md#delete)
* [get](_classclients_.classclients.attributedefinition.md#get)
* [getCollection](_classclients_.classclients.attributedefinition.md#getcollection)
* [query](_classclients_.classclients.attributedefinition.md#query)
* [save](_classclients_.classclients.attributedefinition.md#save)
...
⊕ **new AttributeDefinition**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [AttributeDefinition](_classclients_.classclients.attributedefinition.md)

⊕ **new AttributeDefinition**(client: *[Client](_client_.client.md)*): [AttributeDefinition](_classclients_.classclients.attributedefinition.md)
...
*Defined in [ClassClients.ts:143](https://github.com/ferentchak/rally-node-sdk/blob/45aae0f/ClassClients.ts#L143)*
...
**Returns:** [AttributeDefinition](_classclients_.classclients.attributedefinition.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:144](https://github.com/ferentchak/rally-node-sdk/blob/45aae0f/ClassClients.ts#L144)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`AttributeDefinition`>
...
▸ **getCollection**(rallyObject: *`AttributeDefinition`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`AttributeDefinition`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`AttributeDefinition`>>
