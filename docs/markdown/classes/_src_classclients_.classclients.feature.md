[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Feature](../classes/_src_classclients_.classclients.feature.md)

# Class: Feature

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Feature`>
...
* [constructor](_src_classclients_.classclients.feature.md#constructor)

### Properties

* [client](_src_classclients_.classclients.feature.md#client)
* [typeName](_src_classclients_.classclients.feature.md#typename)

### Methods

* [delete](_src_classclients_.classclients.feature.md#delete)
* [get](_src_classclients_.classclients.feature.md#get)
* [getCollection](_src_classclients_.classclients.feature.md#getcollection)
* [query](_src_classclients_.classclients.feature.md#query)
* [save](_src_classclients_.classclients.feature.md#save)
...
⊕ **new Feature**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Feature](_src_classclients_.classclients.feature.md)

⊕ **new Feature**(client: *[Client](_src_client_.client.md)*): [Feature](_src_classclients_.classclients.feature.md)
...
*Defined in [src/ClassClients.ts:269](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L269)*
...
**Returns:** [Feature](_src_classclients_.classclients.feature.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:270](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L270)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Feature`>
...
▸ **getCollection**(rallyObject: *`Feature`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Feature`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Feature`>>
...
▸ **save**(rallyObject: *`Partial`<`Feature`>*): `Promise`<`Feature`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Feature`> |  A new or existing Rally object |
