[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [UserIterationCapacity](../classes/_classclients_.classclients.useriterationcapacity.md)

# Class: UserIterationCapacity

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`UserIterationCapacity`>
...
* [constructor](_classclients_.classclients.useriterationcapacity.md#constructor)

### Properties

* [client](_classclients_.classclients.useriterationcapacity.md#client)
* [typeName](_classclients_.classclients.useriterationcapacity.md#typename)

### Methods

* [delete](_classclients_.classclients.useriterationcapacity.md#delete)
* [get](_classclients_.classclients.useriterationcapacity.md#get)
* [getCollection](_classclients_.classclients.useriterationcapacity.md#getcollection)
* [query](_classclients_.classclients.useriterationcapacity.md#query)
* [save](_classclients_.classclients.useriterationcapacity.md#save)
...
⊕ **new UserIterationCapacity**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [UserIterationCapacity](_classclients_.classclients.useriterationcapacity.md)

⊕ **new UserIterationCapacity**(client: *[Client](_client_.client.md)*): [UserIterationCapacity](_classclients_.classclients.useriterationcapacity.md)
...
*Defined in [ClassClients.ts:728](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L728)*
...
**Returns:** [UserIterationCapacity](_classclients_.classclients.useriterationcapacity.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:729](https://github.com/ferentchak/rally-node-sdk/blob/55b3a40/ClassClients.ts#L729)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`UserIterationCapacity`>
...
▸ **getCollection**(rallyObject: *`UserIterationCapacity`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`UserIterationCapacity`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`UserIterationCapacity`>>
