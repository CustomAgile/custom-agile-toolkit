[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [SubscriptionTag](../classes/_classclients_.classclients.subscriptiontag.md)

# Class: SubscriptionTag

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`SubscriptionTag`>
...
* [constructor](_classclients_.classclients.subscriptiontag.md#constructor)

### Properties

* [client](_classclients_.classclients.subscriptiontag.md#client)
* [typeName](_classclients_.classclients.subscriptiontag.md#typename)

### Methods

* [delete](_classclients_.classclients.subscriptiontag.md#delete)
* [get](_classclients_.classclients.subscriptiontag.md#get)
* [getCollection](_classclients_.classclients.subscriptiontag.md#getcollection)
* [query](_classclients_.classclients.subscriptiontag.md#query)
* [save](_classclients_.classclients.subscriptiontag.md#save)
...
⊕ **new SubscriptionTag**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [SubscriptionTag](_classclients_.classclients.subscriptiontag.md)

⊕ **new SubscriptionTag**(client: *[Client](_client_.client.md)*): [SubscriptionTag](_classclients_.classclients.subscriptiontag.md)
...
*Defined in [ClassClients.ts:611](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L611)*
...
**Returns:** [SubscriptionTag](_classclients_.classclients.subscriptiontag.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:612](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L612)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`SubscriptionTag`>
...
▸ **getCollection**(rallyObject: *`SubscriptionTag`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`SubscriptionTag`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`SubscriptionTag`>>
