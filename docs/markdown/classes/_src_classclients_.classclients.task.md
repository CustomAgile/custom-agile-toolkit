[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Task](../classes/_src_classclients_.classclients.task.md)

# Class: Task

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Task`>
...
* [constructor](_src_classclients_.classclients.task.md#constructor)

### Properties

* [client](_src_classclients_.classclients.task.md#client)
* [typeName](_src_classclients_.classclients.task.md#typename)

### Methods

* [delete](_src_classclients_.classclients.task.md#delete)
* [get](_src_classclients_.classclients.task.md#get)
* [getCollection](_src_classclients_.classclients.task.md#getcollection)
* [query](_src_classclients_.classclients.task.md#query)
* [save](_src_classclients_.classclients.task.md#save)
...
⊕ **new Task**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Task](_src_classclients_.classclients.task.md)

⊕ **new Task**(client: *[Client](_src_client_.client.md)*): [Task](_src_classclients_.classclients.task.md)
...
*Defined in [src/ClassClients.ts:629](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L629)*
...
**Returns:** [Task](_src_classclients_.classclients.task.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:630](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L630)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Task`>
...
▸ **getCollection**(rallyObject: *`Task`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Task`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Task`>>
...
▸ **save**(rallyObject: *`Partial`<`Task`>*): `Promise`<`Task`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Task`> |  A new or existing Rally object |
