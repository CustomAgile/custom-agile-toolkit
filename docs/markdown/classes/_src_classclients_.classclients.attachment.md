[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Attachment](../classes/_src_classclients_.classclients.attachment.md)

# Class: Attachment

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Attachment`>
...
* [constructor](_src_classclients_.classclients.attachment.md#constructor)

### Properties

* [client](_src_classclients_.classclients.attachment.md#client)
* [typeName](_src_classclients_.classclients.attachment.md#typename)

### Methods

* [delete](_src_classclients_.classclients.attachment.md#delete)
* [get](_src_classclients_.classclients.attachment.md#get)
* [getCollection](_src_classclients_.classclients.attachment.md#getcollection)
* [query](_src_classclients_.classclients.attachment.md#query)
* [save](_src_classclients_.classclients.attachment.md#save)
...
⊕ **new Attachment**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Attachment](_src_classclients_.classclients.attachment.md)

⊕ **new Attachment**(client: *[Client](_src_client_.client.md)*): [Attachment](_src_classclients_.classclients.attachment.md)
...
*Defined in [src/ClassClients.ts:125](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L125)*
...
**Returns:** [Attachment](_src_classclients_.classclients.attachment.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:126](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L126)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Attachment`>
...
▸ **getCollection**(rallyObject: *`Attachment`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Attachment`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Attachment`>>
...
▸ **save**(rallyObject: *`Partial`<`Attachment`>*): `Promise`<`Attachment`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Attachment`> |  A new or existing Rally object |
