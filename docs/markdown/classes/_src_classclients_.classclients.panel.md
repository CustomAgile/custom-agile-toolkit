[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Panel](../classes/_src_classclients_.classclients.panel.md)

# Class: Panel

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Panel`>
...
* [constructor](_src_classclients_.classclients.panel.md#constructor)

### Properties

* [client](_src_classclients_.classclients.panel.md#client)
* [typeName](_src_classclients_.classclients.panel.md#typename)

### Methods

* [delete](_src_classclients_.classclients.panel.md#delete)
* [get](_src_classclients_.classclients.panel.md#get)
* [getCollection](_src_classclients_.classclients.panel.md#getcollection)
* [query](_src_classclients_.classclients.panel.md#query)
* [save](_src_classclients_.classclients.panel.md#save)
...
⊕ **new Panel**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Panel](_src_classclients_.classclients.panel.md)

⊕ **new Panel**(client: *[Client](_src_client_.client.md)*): [Panel](_src_classclients_.classclients.panel.md)
...
*Defined in [src/ClassClients.ts:368](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L368)*
...
**Returns:** [Panel](_src_classclients_.classclients.panel.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:369](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L369)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Panel`>
...
▸ **getCollection**(rallyObject: *`Panel`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Panel`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Panel`>>
...
▸ **save**(rallyObject: *`Partial`<`Panel`>*): `Promise`<`Panel`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Panel`> |  A new or existing Rally object |
