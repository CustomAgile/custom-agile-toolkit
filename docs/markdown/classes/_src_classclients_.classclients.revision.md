[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Revision](../classes/_src_classclients_.classclients.revision.md)

# Class: Revision

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Revision`>
...
* [constructor](_src_classclients_.classclients.revision.md#constructor)

### Properties

* [client](_src_classclients_.classclients.revision.md#client)
* [typeName](_src_classclients_.classclients.revision.md#typename)

### Methods

* [delete](_src_classclients_.classclients.revision.md#delete)
* [get](_src_classclients_.classclients.revision.md#get)
* [getCollection](_src_classclients_.classclients.revision.md#getcollection)
* [query](_src_classclients_.classclients.revision.md#query)
* [save](_src_classclients_.classclients.revision.md#save)
...
⊕ **new Revision**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Revision](_src_classclients_.classclients.revision.md)

⊕ **new Revision**(client: *[Client](_src_client_.client.md)*): [Revision](_src_classclients_.classclients.revision.md)
...
*Defined in [src/ClassClients.ts:512](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L512)*
...
**Returns:** [Revision](_src_classclients_.classclients.revision.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:513](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L513)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Revision`>
...
▸ **getCollection**(rallyObject: *`Revision`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Revision`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Revision`>>
...
▸ **save**(rallyObject: *`Partial`<`Revision`>*): `Promise`<`Revision`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Revision`> |  A new or existing Rally object |
