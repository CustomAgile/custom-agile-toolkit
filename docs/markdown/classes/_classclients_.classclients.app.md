[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [App](../classes/_classclients_.classclients.app.md)

# Class: App

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`App`>
...
* [constructor](_classclients_.classclients.app.md#constructor)

### Properties

* [client](_classclients_.classclients.app.md#client)
* [typeName](_classclients_.classclients.app.md#typename)

### Methods

* [delete](_classclients_.classclients.app.md#delete)
* [get](_classclients_.classclients.app.md#get)
* [getCollection](_classclients_.classclients.app.md#getcollection)
* [query](_classclients_.classclients.app.md#query)
* [save](_classclients_.classclients.app.md#save)
...
⊕ **new App**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [App](_classclients_.classclients.app.md)

⊕ **new App**(client: *[Client](_client_.client.md)*): [App](_classclients_.classclients.app.md)
...
*Defined in [ClassClients.ts:98](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L98)*
...
**Returns:** [App](_classclients_.classclients.app.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:99](https://github.com/ferentchak/rally-node-sdk/blob/6b35ab1/ClassClients.ts#L99)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`App`>
...
▸ **getCollection**(rallyObject: *`App`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`App`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`App`>>
