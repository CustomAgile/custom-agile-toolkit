[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [Subscription](../classes/_src_classclients_.classclients.subscription.md)

# Class: Subscription

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`Subscription`>
...
* [constructor](_src_classclients_.classclients.subscription.md#constructor)

### Properties

* [client](_src_classclients_.classclients.subscription.md#client)
* [typeName](_src_classclients_.classclients.subscription.md#typename)

### Methods

* [delete](_src_classclients_.classclients.subscription.md#delete)
* [get](_src_classclients_.classclients.subscription.md#get)
* [getCollection](_src_classclients_.classclients.subscription.md#getcollection)
* [query](_src_classclients_.classclients.subscription.md#query)
* [save](_src_classclients_.classclients.subscription.md#save)
...
⊕ **new Subscription**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [Subscription](_src_classclients_.classclients.subscription.md)

⊕ **new Subscription**(client: *[Client](_src_client_.client.md)*): [Subscription](_src_classclients_.classclients.subscription.md)
...
*Defined in [src/ClassClients.ts:602](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L602)*
...
**Returns:** [Subscription](_src_classclients_.classclients.subscription.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:603](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L603)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`Subscription`>
...
▸ **getCollection**(rallyObject: *`Subscription`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Subscription`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`Subscription`>>
...
▸ **save**(rallyObject: *`Partial`<`Subscription`>*): `Promise`<`Subscription`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`Subscription`> |  A new or existing Rally object |
