[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [TestCaseStep](../classes/_classclients_.classclients.testcasestep.md)

# Class: TestCaseStep

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`TestCaseStep`>
...
* [constructor](_classclients_.classclients.testcasestep.md#constructor)

### Properties

* [client](_classclients_.classclients.testcasestep.md#client)
* [typeName](_classclients_.classclients.testcasestep.md#typename)

### Methods

* [delete](_classclients_.classclients.testcasestep.md#delete)
* [get](_classclients_.classclients.testcasestep.md#get)
* [getCollection](_classclients_.classclients.testcasestep.md#getcollection)
* [query](_classclients_.classclients.testcasestep.md#query)
* [save](_classclients_.classclients.testcasestep.md#save)
...
⊕ **new TestCaseStep**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [TestCaseStep](_classclients_.classclients.testcasestep.md)

⊕ **new TestCaseStep**(client: *[Client](_client_.client.md)*): [TestCaseStep](_classclients_.classclients.testcasestep.md)
...
*Defined in [ClassClients.ts:656](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L656)*
...
**Returns:** [TestCaseStep](_classclients_.classclients.testcasestep.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:657](https://github.com/ferentchak/rally-node-sdk/blob/181a180/ClassClients.ts#L657)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`TestCaseStep`>
...
▸ **getCollection**(rallyObject: *`TestCaseStep`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TestCaseStep`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`TestCaseStep`>>
