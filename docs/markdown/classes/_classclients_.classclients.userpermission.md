[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [UserPermission](../classes/_classclients_.classclients.userpermission.md)

# Class: UserPermission

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`UserPermission`>
...
* [constructor](_classclients_.classclients.userpermission.md#constructor)

### Properties

* [client](_classclients_.classclients.userpermission.md#client)
* [typeName](_classclients_.classclients.userpermission.md#typename)

### Methods

* [delete](_classclients_.classclients.userpermission.md#delete)
* [get](_classclients_.classclients.userpermission.md#get)
* [getCollection](_classclients_.classclients.userpermission.md#getcollection)
* [query](_classclients_.classclients.userpermission.md#query)
* [save](_classclients_.classclients.userpermission.md#save)
...
⊕ **new UserPermission**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [UserPermission](_classclients_.classclients.userpermission.md)

⊕ **new UserPermission**(client: *[Client](_client_.client.md)*): [UserPermission](_classclients_.classclients.userpermission.md)
...
*Defined in [ClassClients.ts:737](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L737)*
...
**Returns:** [UserPermission](_classclients_.classclients.userpermission.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:738](https://github.com/ferentchak/rally-node-sdk/blob/e12497b/ClassClients.ts#L738)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`UserPermission`>
...
▸ **getCollection**(rallyObject: *`UserPermission`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`UserPermission`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`UserPermission`>>
