[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [PanelDefinitionConfigProperty](../classes/_src_classclients_.classclients.paneldefinitionconfigproperty.md)

# Class: PanelDefinitionConfigProperty

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`PanelDefinitionConfigProperty`>
...
* [constructor](_src_classclients_.classclients.paneldefinitionconfigproperty.md#constructor)

### Properties

* [client](_src_classclients_.classclients.paneldefinitionconfigproperty.md#client)
* [typeName](_src_classclients_.classclients.paneldefinitionconfigproperty.md#typename)

### Methods

* [delete](_src_classclients_.classclients.paneldefinitionconfigproperty.md#delete)
* [get](_src_classclients_.classclients.paneldefinitionconfigproperty.md#get)
* [getCollection](_src_classclients_.classclients.paneldefinitionconfigproperty.md#getcollection)
* [query](_src_classclients_.classclients.paneldefinitionconfigproperty.md#query)
* [save](_src_classclients_.classclients.paneldefinitionconfigproperty.md#save)
...
⊕ **new PanelDefinitionConfigProperty**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [PanelDefinitionConfigProperty](_src_classclients_.classclients.paneldefinitionconfigproperty.md)

⊕ **new PanelDefinitionConfigProperty**(client: *[Client](_src_client_.client.md)*): [PanelDefinitionConfigProperty](_src_classclients_.classclients.paneldefinitionconfigproperty.md)
...
*Defined in [src/ClassClients.ts:377](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L377)*
...
**Returns:** [PanelDefinitionConfigProperty](_src_classclients_.classclients.paneldefinitionconfigproperty.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:378](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L378)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`PanelDefinitionConfigProperty`>
...
▸ **getCollection**(rallyObject: *`PanelDefinitionConfigProperty`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PanelDefinitionConfigProperty`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`PanelDefinitionConfigProperty`>>
