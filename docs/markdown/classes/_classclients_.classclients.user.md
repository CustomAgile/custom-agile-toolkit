[custom-agile-toolkit](../README.md) > ["ClassClients"](../modules/_classclients_.md) > [ClassClients](../modules/_classclients_.classclients.md) > [User](../classes/_classclients_.classclients.user.md)

# Class: User

## Hierarchy

 [ClassClientBase](_classclients_.classclients.classclientbase.md)<`User`>
...
* [constructor](_classclients_.classclients.user.md#constructor)

### Properties

* [client](_classclients_.classclients.user.md#client)
* [typeName](_classclients_.classclients.user.md#typename)

### Methods

* [delete](_classclients_.classclients.user.md#delete)
* [get](_classclients_.classclients.user.md#get)
* [getCollection](_classclients_.classclients.user.md#getcollection)
* [query](_classclients_.classclients.user.md#query)
* [save](_classclients_.classclients.user.md#save)
...
⊕ **new User**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_api_.api.clientoptions.md)*): [User](_classclients_.classclients.user.md)

⊕ **new User**(client: *[Client](_client_.client.md)*): [User](_classclients_.classclients.user.md)
...
*Defined in [ClassClients.ts:719](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L719)*
...
**Returns:** [User](_classclients_.classclients.user.md)

*Overrides [ClassClientBase](_classclients_.classclients.classclientbase.md).[constructor](_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [ClassClients.ts:720](https://github.com/ferentchak/rally-node-sdk/blob/52b036e/ClassClients.ts#L720)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<`User`>
...
▸ **getCollection**(rallyObject: *`User`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<[RallyObject](../interfaces/_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`User`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_api_.api.queryresponse.md)<`User`>>
