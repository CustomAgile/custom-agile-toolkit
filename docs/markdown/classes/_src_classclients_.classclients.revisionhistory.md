[custom-agile-toolkit](../README.md) > ["src/ClassClients"](../modules/_src_classclients_.md) > [ClassClients](../modules/_src_classclients_.classclients.md) > [RevisionHistory](../classes/_src_classclients_.classclients.revisionhistory.md)

# Class: RevisionHistory

## Hierarchy

 [ClassClientBase](_src_classclients_.classclients.classclientbase.md)<`RevisionHistory`>
...
* [constructor](_src_classclients_.classclients.revisionhistory.md#constructor)

### Properties

* [client](_src_classclients_.classclients.revisionhistory.md#client)
* [typeName](_src_classclients_.classclients.revisionhistory.md#typename)

### Methods

* [delete](_src_classclients_.classclients.revisionhistory.md#delete)
* [get](_src_classclients_.classclients.revisionhistory.md#get)
* [getCollection](_src_classclients_.classclients.revisionhistory.md#getcollection)
* [query](_src_classclients_.classclients.revisionhistory.md#query)
* [save](_src_classclients_.classclients.revisionhistory.md#save)
...
⊕ **new RevisionHistory**(apiKey: *`string`*, options: *[ClientOptions](../interfaces/_src_api_.api.clientoptions.md)*): [RevisionHistory](_src_classclients_.classclients.revisionhistory.md)

⊕ **new RevisionHistory**(client: *[Client](_src_client_.client.md)*): [RevisionHistory](_src_classclients_.classclients.revisionhistory.md)
...
*Defined in [src/ClassClients.ts:521](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L521)*
...
**Returns:** [RevisionHistory](_src_classclients_.classclients.revisionhistory.md)

*Overrides [ClassClientBase](_src_classclients_.classclients.classclientbase.md).[constructor](_src_classclients_.classclients.classclientbase.md#constructor)*

*Defined in [src/ClassClients.ts:522](https://github.com/ferentchak/rally-node-sdk/blob/4c2e61e/src/ClassClients.ts#L522)*
...
▸ **get**(typeOrRef: *`string`*, objectID?: *`number`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<`RevisionHistory`>
...
**Returns:** `Promise`<`RevisionHistory`>
...
▸ **getCollection**(rallyObject: *`RevisionHistory`*, collectionName: *`string`*, params?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<[RallyObject](../interfaces/_src_api_.api.rallyobject.md)>>
...
▸ **query**(type: *`any`*, query?: *[QueryOptions](../interfaces/_src_api_.api.queryoptions.md)*, params?: *`object`*): `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`RevisionHistory`>>
...
**Returns:** `Promise`<[QueryResponse](../interfaces/_src_api_.api.queryresponse.md)<`RevisionHistory`>>
...
▸ **save**(rallyObject: *`Partial`<`RevisionHistory`>*): `Promise`<`RevisionHistory`>
...
| ------ | ------ | ------ |
| rallyObject | `Partial`<`RevisionHistory`> |  A new or existing Rally object |
